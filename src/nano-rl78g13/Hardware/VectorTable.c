...
const unsigned char Security_Id[] __attribute__((section(".security_id"))) = {
   0xEA, 0x42, 0x2B, 0x82, 0xAB, 0x42, 0x6A, 0x7D, 0x07, 0x03
};
...
void INT_P6(void) __attribute__((weak, alias("Ignore")));
void INT_P7(void) __attribute__((weak, alias("Ignore")));
void INT_P8(void) __attribute__((weak, alias("Ignore")));
void INT_P9(void) __attribute__((weak, alias("Ignore")));
void INT_P10(void) __attribute__((weak, alias("Ignore")));
void INT_P11(void) __attribute__((weak, alias("Ignore")));
