...
*                FLASH_ERR_FREQUENCY -
*                    BSP_FCLK_HZ not between 1MHz and 32MHz
*                FLASH_ERR_BUSY -
...
flash_err_t flash_api_open(void)
{
    ...
    if ((FLASH_CLOCK_HZ > 32000000) || (FLASH_CLOCK_HZ < 1000000))
    {
...
flash_err_t flash_api_erase(flash_block_address_t block_start_address, uint32_t num_blocks)
{
    ...
    {
#if (BSP_ROM_SIZE_BYTES > 0x40000L) && !defined(BSP_MCU_RX23_ALL)
...
* Return Value : none
*******************************************************************************/
static inline void r_flash_delay  () __attribute__ ((always_inline));
static inline void r_flash_delay  ()
{
__asm("    BRA     ?+  \n"
"    NOP              \n"
"?:                   \n"
...
* Return Value : none
******************************************************************************/
void FCU_FRDYI(void) __attribute__ ((interrupt));
void FCU_FRDYI(void)
{
    flash_err_t err = FLASH_SUCCESS;
