...
#ifndef REFRIGERATORMODELTYPE_H
#define REFRIGERATORMODELTYPE_H

#include <stdint.h>

enum
{
   RefrigeratorModelType_BottomFreezerFrenchDoor,
   RefrigeratorModelType_BottomFreezerOneDoor,
   RefrigeratorModelType_SideBySide,
   ...
   RefrigeratorModelType_BeverageCenter,
   RefrigeratorModelType_FAndPColumnsFreshFood,
   RefrigeratorModelType_FAndPColumnsFreezer,
   RefrigeratorModelType_FAndP60cmSingleDoor,
   RefrigeratorModelType_FAndP60cmMultiDoor,
   RefrigeratorModelType_FAndPRF605Platform,
