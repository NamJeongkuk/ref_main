...
enum
{
   ...
   FaultId_IceCabinetFanMissingFanFeedbackWhenFanIsRunning = 109,
   FaultId_IceCabinetFanFeedbackPresentWhenFanIsOff = 110,
   FaultId_IceCabinetFanCannotReachTargetRpm = 111,
   ...
   FaultId_IceMaker2TwistTrayMotorFault = 662,
