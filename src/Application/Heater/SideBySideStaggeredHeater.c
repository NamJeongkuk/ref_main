...
static void FreshFoodDamperHeaterSoftPwm_Init(
   SoftPwm_t *softPwm,
...
{
   FreshFoodDamperHeaterSoftPwm_Init(
      &instance->_private.freshFoodDamperHeaterSoftPwm, dataModel, FirstHeaterDelay);
