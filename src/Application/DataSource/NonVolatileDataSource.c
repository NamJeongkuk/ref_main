...
#define EXPAND_AS_ASYNC_MAP_ELEMENTS(Name, Number, DataType, Swap, Io, StorageType, Public, NvDefaultData, FaultId) \
...
#define EXPAND_AS_SYNC_CONFIGURATION(Name, Number, DataType, Swap, Io, StorageType, Public, NvDefaultData, FaultId) \
