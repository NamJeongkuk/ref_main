...
static const DataSource_EndiannessSwappedSwappedField_t swappedFields[] = {
   ...
   SWAPPED_ERD(PublicErd_IceMakerMoldThermistor_AdcCount, sizeof(AdcCounts_t)),
...
static const DataSource_EndiannessSwappedSwappedFieldRange_t swappedRanges[] = {
   ...
   SWAPPED_FIELD_RANGE(PublicErd_IceMakerMoldThermistor_AdcCount, PublicErd_ConvertibleCompartmentEvapThermistor_AdcCount),
