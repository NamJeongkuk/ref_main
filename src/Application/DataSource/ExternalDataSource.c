...
static const DataSource_EndiannessSwappedSwappedFieldRange_t swappedRanges[] = {
   ...
   SWAPPED_FIELD_RANGE(PublicErd_FreshFood_AdjustedSetpointInDegFx100, PublicErd_Freezer_AdjustedSetpointWithoutShiftInDegFx100),
   SWAPPED_FIELD_RANGE(PublicErd_FreshFood_ResolvedSetpointInDegFx100, PublicErd_Freezer_HighAmbientOffsetInDegFx100),
   SWAPPED_FIELD_RANGE(PublicErd_FreezerSetpoint_FactoryVote, PublicErd_FreezerSetpoint_ColdestSetpointVote),
   SWAPPED_FIELD_RANGE(PublicErd_FreezerSetpoint_TurboFreezeVote, PublicErd_FreezerSetpoint_UserVote),
   SWAPPED_FIELD_RANGE(PublicErd_FreshFoodSetpoint_FactoryVote, PublicErd_FreshFoodSetpoint_ColdestSetpointVote),
   SWAPPED_FIELD_RANGE(PublicErd_FreshFoodSetpoint_TurboCoolVote, PublicErd_FreshFoodSetpoint_UserVote),
