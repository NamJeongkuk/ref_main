...
#define EXPAND_AS_INPUT_AND_INPUT_OUTPUT_NON_RAM_ERDS(Name, Number, DataType, Swap, Io, StorageType, NvDefaultData, FaultId) \
...
#define EXPAND_AS_OUTPUT_NON_RAM_ERDS(Name, Number, DataType, Swap, Io, StorageType, NvDefaultData, FaultId) \
