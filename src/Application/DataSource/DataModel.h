...
#define EXPAND_AS_INPUT_AND_INPUT_OUTPUT_ERDS_TYPE(Name, Number, DataType, Swap, Io, StorageType, Public, NvDefaultData, FaultId) \
   CONCAT(INCLUDE_INPUT_OUTPUT_, Io)                                                                                                \
   (uint8_t Name;)

#define EXPAND_AS_OUTPUT_ERDS_TYPE(Name, Number, DataType, Swap, Io, StorageType, Public, NvDefaultData, FaultId) \
