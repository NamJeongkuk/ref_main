...
#define ERD_TABLE(ENTRY)  \
   ...
   \
   ENTRY(Erd_FreshFoodDamperPosition_ResolvedVote,                   0xF319, DamperVotedPosition_t,                     Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodDamperPosition_WinningVoteErd,                 0xF31A, WinningVoteErd_t,                          Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
