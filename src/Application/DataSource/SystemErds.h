...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_ConvertibleCompartmentAsFreezer_FilteredTemperatureInDegFx100,  0xF0DA, TemperatureDegFx100_t,             Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
