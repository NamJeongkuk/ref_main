...
#define ERD_TABLE(ENTRY)  \
   ...
   \
   ENTRY(Erd_IceMaker0_HarvestCountCalculationRequest,                 0xF13A, bool,                                    Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_IceMaker1_HarvestCountCalculationRequest,                 0xF13B, bool,                                    Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_IceMaker2_HarvestCountCalculationRequest,                 0xF13C, bool,                                    Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ...
   ENTRY(Erd_IceMaker1_TestRequest,                         0xF15D, IceMakerTestRequest_t,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ...
   \
   ENTRY(Erd_IceMaker2_TestRequest,                         0xF16A, IceMakerTestRequest_t,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   \
   ENTRY(Erd_IceMaker0_HeaterRelay_ResolvedVote,            0xF2A0, HeaterVotedState_t,                                 Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_IceMaker0_HeaterRelay_WinningVoteErd,          0xF2A1, WinningVoteErd_t,                                   Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_IceMaker0_HeaterRelay_FactoryVote,             0xF2A2, HeaterVotedState_t,                                 Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_IceMaker0_HeaterRelay_IceMakerVote,            0xF2A3, HeaterVotedState_t,                                 Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
