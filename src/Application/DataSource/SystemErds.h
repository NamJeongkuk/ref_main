...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_ConvertibleCompartmentSetpoint_WinningVoteErd, 0xF152, WinningVoteErd_t,                                   Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_CompressorSpeed_WinningVoteErd,                0xF211, WinningVoteErd_t,                                   Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_CondenserFanSpeed_GridVote,                    0xF234, FanVotedSpeed_t,                                    Swap_N, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_FreshFoodFanSpeed_WinningVoteErd,              0xF341, WinningVoteErd_t,                                   Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ...
   \
   ENTRY(Erd_FreshFood_CabinetOffsetInDegFx100,             0xF391, TemperatureDegFx100_t,                              Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ENTRY(Erd_Freezer_CabinetOffsetInDegFx100,               0xF397, TemperatureDegFx100_t,                              Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ENTRY(Erd_IceBox_CabinetOffsetInDegFx100,                0xF39F, TemperatureDegFx100_t,                              Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
