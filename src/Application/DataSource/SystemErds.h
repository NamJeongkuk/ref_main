...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_IceMaker0_HarvestCountCalculationRequest,                 0xF14D, bool,                                    Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_IceMaker1_HarvestCountCalculationRequest,                 0xF14E, bool,                                    Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_IceMaker2_HarvestCountCalculationRequest,                 0xF14F, bool,                                    Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
