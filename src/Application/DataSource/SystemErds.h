...
\
   ...
   ENTRY(Erd_FreshFoodTemperatureExceededFault,             0xF740, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                                       NotNv,         FaultId_FreshFoodTemperatureExceeded) \
   ENTRY(Erd_FreezerTemperatureExceededFault,               0xF741, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                                       NotNv,         FaultId_FreezerTemperatureExceeded) \
   ENTRY(Erd_AndroidSignOfLifeDebugFault,                   0xF742, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                                       NotNv,         FaultId_AndroidSbcSignOfLifeFault) \
   ENTRY(Erd_IceWaterStopsDispensingBasedOnTimeFault,       0xF743, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                                       NotNv,         FaultId_IceWaterStopsDispensingBasedOnTime) \
   \
