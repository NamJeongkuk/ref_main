...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_IceCabinetFanSpeed_FreezerFanDependencyVote,   0xF218, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_IceCabinetFanSpeed_IceCabinetGridVote,         0xF219, FanVotedSpeed_t,                                    Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
   ENTRY(Erd_FreshFoodEvapFanSpeed_ResolvedVote,            0xF21A, FanVotedSpeed_t,                                    Swap_Yes,     Io_None, Sub_Y, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_WinningVoteErd,          0xF21B, WinningVoteErd_t,                                   Swap_Yes,     Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_FactoryServiceVote,      0xF21C, FanVotedSpeed_t,                                    Swap_Range_S, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_CoolingSystemOffVote,    0xF21D, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_DemoVote,                0xF21E, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_LoadOffDoorOpenVote,     0xF21F, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_DefrostVote,             0xF220, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_NonHeatedCycleDefrostVote, 0xF221, FanVotedSpeed_t,                                  Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_EnhancedSabbathVote,     0xF222, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_CompressorStartUpVote,   0xF223, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_CompressorSealedSystemValveDelayVote, 0xF224, FanVotedSpeed_t,                       Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_DeliPanSpeedVote,        0xF225, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_GridVote,                0xF226, FanVotedSpeed_t,                                    Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
