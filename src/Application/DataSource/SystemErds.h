...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_ConvertibleCompartment_LongTermAverageInDegFx100, 0xF0E3, TemperatureDegFx100_t,                           Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   ENTRY(Erd_FeaturePan_AdjustedSetpointInDegFx100,                           0xF0FE, TemperatureDegFx100_t,            Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFood_AdjustedSetpointInDegFx100,                            0xF0FF, TemperatureDegFx100_t,            Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ...
   ENTRY(Erd_ConvertibleCompartment_AdjustedSetpointInDegFx100,               0xF101, TemperatureDegFx100_t,            Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFood_AdjustedSetpointWithoutShiftInDegFx100,                0xF102, TemperatureDegFx100_t,            Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_Freezer_AdjustedSetpointWithoutShiftInDegFx100,                  0xF103, TemperatureDegFx100_t,            Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_ConvertibleCompartment_AdjustedSetpointWithoutShiftInDegFx100,   0xF104, TemperatureDegFx100_t,            Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
