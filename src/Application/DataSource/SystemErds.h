...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_EnhancedSabbathModeEnable,                     0x004F, bool,                                               Swap_No,  Io_None, Sub_Y, NvUnitSetting,          NonVolatileDataSourceDefaultData_BooleanFalse, NotFault) \
   ...
   \
   ENTRY(Erd_UiSoundLevelRequest,                           0x0902, uint8_t,                                            Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_UiSoundLevelState,                             0x0903, uint8_t,                                            Swap_No,  Io_None, Sub_N, NvUserSetting,          NonVolatileDataSoundDefaultData_LowSoundLevel,   NotFault) \
   ...
   ENTRY(Erd_TurboCoolOnOffStatus,                          0x120D, bool,                                               Swap_No,  Io_None, Sub_Y, NvUserSetting,          NonVolatileDataSourceDefaultData_BooleanFalse,      NotFault) \
   ...
   ENTRY(Erd_TurboFreezeOnOffStatus,                        0x121B, bool,                                               Swap_No,  Io_None, Sub_Y, NvUserSetting,          NonVolatileDataSourceDefaultData_BooleanFalse,      NotFault) \
   \
   ...
   ENTRY(Erd_NotificationsBitmap,                           0x122E, NotificationsBitmap_t,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry10,           0xE10F, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry11,           0xE110, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry12,           0xE111, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry13,           0xE112, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry14,           0xE113, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry15,           0xE114, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry16,           0xE115, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry17,           0xE116, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry18,           0xE117, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableEntry19,           0xE118, ServiceDiagnosticsRevision3FaultTableEntry_t,       Swap_Range_E, Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot0,         0xE119, FaultSnapshot_t,                                    Swap_Range_S, Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot1,         0xE11A, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot2,         0xE11B, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot3,         0xE11C, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot4,         0xE11D, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot5,         0xE11E, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot6,         0xE11F, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot7,         0xE120, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot8,         0xE121, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot9,         0xE122, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot10,        0xE123, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot11,        0xE124, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot12,        0xE125, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot13,        0xE126, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot14,        0xE127, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot15,        0xE128, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot16,        0xE129, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot17,        0xE12A, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot18,        0xE12B, FaultSnapshot_t,                                    Swap_Range,   Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshot19,        0xE12C, FaultSnapshot_t,                                    Swap_Range_E, Io_None, Sub_N, Virtual,            NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceStatus,         0xE12D, ServiceDiagnosticsRevision3SequenceStatus_t,        Swap_Yes,   Io_None, Sub_N, NvFaultSnapshot,      NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceClear,          0xE12E, ServiceDiagnosticsRevision3SequenceClearRequest_t,  Swap_No,    Io_O,    Sub_N, Virtual,              NotNv,                                    NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceEntry0,         0xE12F, ServiceDiagnosticsRevision3FaultSequenceEntry_t,    Swap_Range_S, Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceEntry1,         0xE130, ServiceDiagnosticsRevision3FaultSequenceEntry_t,    Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceEntry2,         0xE131, ServiceDiagnosticsRevision3FaultSequenceEntry_t,    Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceEntry3,         0xE132, ServiceDiagnosticsRevision3FaultSequenceEntry_t,    Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceEntry4,         0xE133, ServiceDiagnosticsRevision3FaultSequenceEntry_t,    Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceEntry5,         0xE134, ServiceDiagnosticsRevision3FaultSequenceEntry_t,    Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceEntry6,         0xE135, ServiceDiagnosticsRevision3FaultSequenceEntry_t,    Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultSequenceEntry7,         0xE136, ServiceDiagnosticsRevision3FaultSequenceEntry_t,    Swap_Range_E, Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsCycleHistorySequenceStatus,  0xE137, ServiceDiagnosticsRevision3SequenceStatus_t,        Swap_Yes,   Io_None, Sub_N, NvFaultSnapshot,      NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsCycleHistorySequenceClear,   0xE138, ServiceDiagnosticsRevision3SequenceClearRequest_t,  Swap_No,    Io_O,    Sub_N, Virtual,              NotNv,                                    NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord0,                0xE139, CycleHistoryRecord_t,                               Swap_Range_S, Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord1,                0xE13A, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord2,                0xE13B, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord3,                0xE13C, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord4,                0xE13D, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord5,                0xE13E, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord6,                0xE13F, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord7,                0xE140, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord8,                0xE141, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_DiagnosticsCycleHistoryRecord9,                0xE142, CycleHistoryRecord_t,                               Swap_Range,   Io_None, Sub_N, NvCycleHistory,     NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsCycleHistoryAddEntry,        0xE143, CycleHistoryRecord_t,                               Swap_Range_E, Io_O,    Sub_N, Virtual,            NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   \
   ...
   ENTRY(Erd_CurrentDefrostType,                            0xF064, DefrostType_t,                                      Swap_No,  Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_FullDefrost, NotFault) \
   ENTRY(Erd_NextDefrostType,                               0xF065, DefrostType_t,                                      Swap_No,  Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_FullDefrost, NotFault) \
   ENTRY(Erd_NumberOfFreshFoodDefrostsBeforeAFullDefrost,   0xF066, uint8_t,                                            Swap_No,  Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_NumberOfFreezerDefrosts,                       0xF067, uint16_t,                                           Swap_Yes, Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_NumberOfFreshFoodDefrosts,                     0xF068, uint8_t,                                            Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_TimeBetweenDefrostsInMinutes,                  0xF069, uint16_t,                                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_WaitingForDefrostTimeInSeconds,                0xF06A, uint32_t,                                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DefrostCompressorOnTimeInSeconds,              0xF06B, uint32_t,                                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_LeftSideFreshFoodScaledDoorAccelerationInSeconds,  0xF06C, uint32_t,                                       Swap_Range_S, Io_None, Sub_N, Ram,                NotNv,                                    NotFault) \
   ENTRY(Erd_RightSideFreshFoodScaledDoorAccelerationInSeconds, 0xF06D, uint32_t,                                       Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                    NotFault) \
   ENTRY(Erd_DoorInDoorScaledDoorAccelerationInSeconds,         0xF06E, uint32_t,                                       Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerScaledDoorAccelerationInSeconds,            0xF06F, uint32_t,                                       Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                    NotFault) \
   ENTRY(Erd_ConvertibleCompartmentAsFreshFoodScaledDoorAccelerationInSeconds, 0xF070, uint32_t,                        Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                    NotFault) \
   ENTRY(Erd_ConvertibleCompartmentAsFreezerScaledDoorAccelerationInSeconds,   0xF071, uint32_t,                        Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                    NotFault) \
   ENTRY(Erd_ReadyToDefrost,                                0xF072, bool,                                               Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_ReadyToDefrostHsmState,                        0xF073, ReadyToDefrostHsmState_t,                           Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_TimeThatPrechillConditionsAreMetInMinutes,     0xF074, uint16_t,                                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerDefrostHeaterOnTimeInMinutes,           0xF076, uint8_t,                                            Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerDefrostHeaterMaxOnTimeInMinutes,        0xF077, uint8_t,                                            Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreshFoodDefrostHeaterMaxOnTimeInMinutes,      0xF078, uint8_t,                                            Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_ConvertibleCompartmentDefrostHeaterMaxOnTimeInMinutes, 0xF079, uint8_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerDefrostWasAbnormal,                     0xF07A, bool,                                               Swap_No,  Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_NumberOfFreezerAbnormalDefrosts,               0xF07B, uint16_t,                                           Swap_Yes, Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_FreshFoodDefrostWasAbnormal,                   0xF07C, bool,                                               Swap_No,  Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ConvertibleCompartmentDefrostWasAbnormal,      0xF07D, bool,                                               Swap_No,  Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_PostDwellExitTimeInMinutes,                    0xF07E, uint8_t,                                            Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_PostDwellCompletionSignal,                     0xF07F, Signal_t,                                           Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_InvalidFreezerEvaporatorThermistorDuringDefrost,0xF080,bool,                                               Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerFilteredTemperatureTooWarmOnPowerUp,    0xF081, bool,                                               Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_CompressorIsOn,                                0xF082, bool,                                               Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DisableDefrost,                                0xF083, bool,                                               Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DefrostTestRequest,                            0xF084, DefrostTestRequest_t,                               Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DefrostTestStateRequest,                       0xF085, DefrostTestStateRequestMessage_t,                   Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DefrostTestRequestStatus,                      0xF086, DefrostTestRequest_t,                               Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DontSkipDefrostPrechill,                       0xF087, bool,                                               Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_UseAhamPrechillReadyToDefrostTimeAndResetDefrostCounts, 0xF088, bool,                                      Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_SabbathIsReadyToDefrost,                       0xF089, bool,                                               Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_SabbathTimeBetweenDefrostsInMinutes,           0xF08A, uint16_t,                                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_SabbathWaitingForDefrostTimeInMinutes,         0xF08B, uint16_t,                                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_LastAluminumMoldIceMakerWaterValveOnTimeInSeconds, 0xF178, uint32_t,                                       Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_LastTwistTrayIceMakerWaterValveOnTimeInSeconds,    0xF179, uint32_t,                                       Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_LastDispensedWaterValveOnTimeInSeconds,        0xF17A, uint32_t,                                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_RfidFilterWaterVolumeUsageInOuncesX100_RfidBoard,  0xF184, VolumeInOuncesX100_t,                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterCalendarUsageInSeconds_RfidBoard,    0xF185, CalendarUsageInSeconds_t,                           Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterLeakDetectedTimeInSeconds_RfidBoard, 0xF186, LeakDetectedInSeconds_t,                            Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterNumberOfWriteOperations_RfidBoard,   0xF187, NumberOfWriteOperations_t,                          Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterStatus_RfidBoard,                    0xF188, FilterStatusRfidBoard_t,                            Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterInitializationErrorBitfield_RfidBoard,       0xF189, RfidFilterInitializationErrorBitfield_t,    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterLockByte_RfidBoard,                          0xF18A, uint8_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterNumberOfUnitsRfidFilterHasBeenOn_RfidBoard,  0xF18B, RfidFilterNumberOfUnitsFilterHasBeenOn_t,   Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterUnitSerialNumber_RfidBoard,                  0xF18C, UnitSerialNumber_t,                         Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_RfidFilterPreviousUnitSerialNumber_RfidBoard,          0xF18D, UnitSerialNumber_t,                         Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_CondenserFanSpeed_FactoryServiceVote,          0xF202, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_CondenserFanSpeed_CoolingSystemOffVote,        0xF203, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_CondenserFanSpeed_DemoVote,                    0xF204, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_CondenserFanSpeed_DefrostVote,                 0xF205, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_CondenserFanSpeed_SabbathVote,                 0xF206, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_CondenserFanSpeed_CompressorStartUpVote,       0xF207, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_CondenserFanSpeed_GridVote,                    0xF208, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_IceCabinetFanSpeed_FactoryServiceVote,         0xF212, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_IceCabinetFanSpeed_CoolingSystemOffVote,       0xF213, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_IceCabinetFanSpeed_DemoVote,                   0xF214, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_IceCabinetFanSpeed_LoadOffDoorOpenVote,        0xF215, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_IceCabinetFanSpeed_DefrostVote,                0xF216, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_FreshFoodEvapFanSpeed_FactoryServiceVote,      0xF21C, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_CoolingSystemOffVote,    0xF21D, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_DemoVote,                0xF21E, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_LoadOffDoorOpenVote,     0xF21F, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_DefrostVote,             0xF220, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_SabbathVote,             0xF221, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_CompressorStartUpVote,   0xF222, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_GridVote,                0xF223, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_FreezerEvapFanSpeed_FactoryServiceVote,        0xF22C, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_CoolingSystemOffVote,      0xF22D, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_DemoVote,                  0xF22E, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_LoadOffDoorOpenVote,       0xF22F, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_DefrostVote,               0xF230, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_SabbathVote,               0xF231, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_CompressorStartUpVote,     0xF232, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_FreezerIceRateVote,        0xF233, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_GridVote,                  0xF234, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_ConvertibleCompartmentFanSpeed_FactoryServiceVote,   0xF23C, FanVotedSpeed_t,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_ConvertibleCompartmentFanSpeed_CoolingSystemOffVote, 0xF23D, FanVotedSpeed_t,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_ConvertibleCompartmentFanSpeed_DemoVote,       0xF23E, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_ConvertibleCompartmentFanSpeed_LoadOffDoorOpenVote,  0xF23F, FanVotedSpeed_t,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_ConvertibleCompartmentFanSpeed_DefrostVote,    0xF240, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_ConvertibleCompartmentFanSpeed_GridVote,       0xF241, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_DeliFanSpeed_FactoryServiceVote,               0xF24C, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DeliFanSpeed_CoolingSystemOffVote,             0xF24D, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DeliFanSpeed_DemoVote,                         0xF24E, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DeliFanSpeed_LoadOffDoorOpenVote,              0xF24F, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DeliFanSpeed_DefrostVote,                      0xF250, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_DeliFanSpeed_GridVote,                         0xF251, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
...
\
   ...
   ENTRY(Erd_Ambient_FilteredInternalHumidityOverrideValueInPercentx100,     0xF45B, RelativeHumidityPercentx100_t,     Swap_Range_S, Io_None, Sub_N, Ram,                NotNv,                                    NotFault) \
   ENTRY(Erd_Ambient_FilteredInternalHumidityResolvedInPercentx100,          0xF45C, RelativeHumidityPercentx100_t,     Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_AluminumMoldIceMakerWaterValveRelay,           0xF507, bool,                                               Swap_No,  Io_None, Sub_Y, MappedBsp,              NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_DispenserValveRelay,                           0xF50C, bool,                                               Swap_No,  Io_None, Sub_Y, MappedBsp,              NotNv,                                    NotFault) \
   ENTRY(Erd_IsolationValveRelay,                           0xF50D, bool,                                               Swap_No,  Io_None, Sub_N, MappedBsp,              NotNv,                                    NotFault) \
   ENTRY(Erd_TwistTrayIceMakerWaterValveRelay,              0xF50E, bool,                                               Swap_No,  Io_None, Sub_Y, MappedBsp,              NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_SoftPwmGpio_HTR_00,                            0xF612, bool,                                               Swap_No, Io_None, Sub_N, Bsp,                     NotNv,                                    NotFault) \
   ENTRY(Erd_SoftPwmGpio_HTR_01,                            0xF613, bool,                                               Swap_No, Io_None, Sub_N, Bsp,                     NotNv,                                    NotFault) \
   ENTRY(Erd_SoftPwmGpio_HTR_02,                            0xF614, bool,                                               Swap_No, Io_None, Sub_N, Bsp,                     NotNv,                                    NotFault) \
   ENTRY(Erd_SoftPwmGpio_HTR_03,                            0xF615, bool,                                               Swap_No, Io_None, Sub_N, Bsp,                     NotNv,                                    NotFault) \
   ENTRY(Erd_SoftPwmGpio_HTR_04,                            0xF616, bool,                                               Swap_No, Io_None, Sub_N, Bsp,                     NotNv,                                    NotFault) \
   ...
   \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData0,     0xF680, FaultSnapshotData_t,                                Swap_Range_S, Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData1,     0xF681, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData2,     0xF682, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData3,     0xF683, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData4,     0xF684, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData5,     0xF685, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData6,     0xF686, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData7,     0xF687, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData8,     0xF688, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData9,     0xF689, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData10,    0xF68A, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData11,    0xF68B, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData12,    0xF68C, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData13,    0xF68D, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData14,    0xF68E, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData15,    0xF68F, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData16,    0xF690, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData17,    0xF691, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData18,    0xF692, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData19,    0xF693, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData20,    0xF694, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData21,    0xF695, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData22,    0xF696, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData23,    0xF697, FaultSnapshotData_t,                                Swap_Range,   Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   ENTRY(Erd_ServiceDiagnosticsFaultTableSnapshotData24,    0xF698, FaultSnapshotData_t,                                Swap_Range_E, Io_None, Sub_N, NvFaultSnapshot,    NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   \
   ...
   \
   ENTRY(Erd_DoorBoardCommunicationFault,                   0xF720, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                    FaultId_DoorBoardCommunicationFault) \
   ENTRY(Erd_DispenserUiCommunicationFault,                 0xF721, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                    FaultId_DispenserUiCommunicationFault) \
   ...
   ENTRY(Erd_EmbeddedWifiCommunicationFault,                0xF723, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                    FaultId_EmbeddedWifiCommunicationFault) \
   ENTRY(Erd_InternalTemperatureUiCommunicationFault,       0xF724, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                    FaultId_InternalTemperatureUiCommunicationFault) \
   ENTRY(Erd_RfidBoardHardwareFailureFault,                 0xF725, bool,                                               Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                    FaultId_RfidBoardHardwareFailureFault) \
   ...
   ENTRY(Erd_FreezerEvapFanMissingFanFeedbackWhenFanIsRunningFault, 0xF739, bool,                                       Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                    FaultId_FreezerEvapFanMissingFanFeedbackWhenFanIsRunning) \
   ENTRY(Erd_FreezerEvapFanFeedbackPresentWhenFanIsOffFault,        0xF73A, bool,                                       Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                    FaultId_FreezerEvapFanFeedbackPresentWhenFanIsOff) \
   ENTRY(Erd_FreezerEvapFanCannotReachTargetRpmFault,               0xF73B, bool,                                       Swap_No,  Io_None, Sub_N, Fault,                  NotNv,                                    FaultId_FreezerEvapFanCannotReachTargetRpm) \
   ...
   ENTRY(Erd_Eeprom_EnhancedSabbathRunTimeInMinutes,        0xFB19, uint16_t,                                           Swap_Yes, Io_None, Sub_N, NvUnitSetting,          NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
   \
