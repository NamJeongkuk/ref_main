...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_InternalUart,                          0xF103, I_BufferedUart_t *,                                 Swap_N, Io_None, Sub_N, Ram,      NotNv,                                    NotFault) \
   ENTRY(Erd_ExternalUart,                          0xF104, I_BufferedUart_t *,                                 Swap_N, Io_None, Sub_N, Ram,      NotNv,                                    NotFault) \
