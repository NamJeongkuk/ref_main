...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_ConvertibleCompartmentEvapFanSpeed_GridVote,             0xF241, FanVotedSpeed_t,                          Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   ENTRY(Erd_DeliFanSpeed_GridVote,                         0xF251, FanVotedSpeed_t,                                    Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   ENTRY(Erd_ConvertibleCompartmentHeater_WarmupSlopeVote,  0xF2F4, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   \
   ENTRY(Erd_DamperHeater_ResolvedVote,                     0xF30B, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DamperHeater_WinningVoteErd,                   0xF30C, WinningVoteErd_t,                                   Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DamperHeater_FactoryVote,                      0xF30D, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DamperHeater_CoolingSystemOffVote,             0xF30E, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DamperHeater_DamperFreezePreventionVote,       0xF30F, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DamperHeater_DefrostHeaterSyncVote,            0xF310, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ENTRY(Erd_DeliPanHeater_ResolvedVote,                    0xF311, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DeliPanHeater_WinningVoteErd,                  0xF312, WinningVoteErd_t,                                   Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DeliPanHeater_FactoryVote,                     0xF313, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DeliPanHeater_DisableForAmbientTemperatureVote, 0xF314, PercentageDutyCycleVote_t,                         Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DeliPanHeater_WarmupSlopeVote,                 0xF315, PercentageDutyCycleVote_t,                          Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   ENTRY(Erd_SealedSystemValvePosition_PowerUpVote,      0xF32F, SealedSystemValveVotedPosition_t,                      Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_SealedSystemValvePosition_DefrostVote,      0xF330, SealedSystemValveVotedPosition_t,                      Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_SealedSystemValvePosition_GridVote,         0xF331, SealedSystemValveVotedPosition_t,                      Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   ENTRY(Erd_DeliDamperPosition_GridVote,                       0xF364, DamperVotedPosition_t,                          Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
