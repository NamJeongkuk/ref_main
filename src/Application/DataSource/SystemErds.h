...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_FreezerDefrostHeaterOnTimeInMinutes,           0xF076, uint8_t,                                            Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                     
     NotNv,         NotFault) \
   ...
   ENTRY(Erd_ConvertibleCompartment_FilteredTemperatureResolvedInDegFx100, 0xF0D8, TemperatureDegFx100_t,               Swap_Yes,     Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
...
\
   ...
   \
   ENTRY(Erd_ConvertibleCompartmentDoorStatus_SabbathOverrideRequest,        0xF469, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_ConvertibleCompartmentDoorStatus_SabbathOverrideValue,          0xF46A, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_ConvertibleCompartmentDoorStatus_TestingOverrideRequest,        0xF46B, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_ConvertibleCompartmentDoorStatus_TestingOverrideValue,          0xF46C, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   ENTRY(Erd_DamperHeaterPwmDutyCycle,                      0xF55E, PwmDutyCycle_t,                                     Swap_Yes, Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
