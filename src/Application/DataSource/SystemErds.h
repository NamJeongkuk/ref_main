...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_FreshFoodEvapFanSpeed_NonHeatedCycleDefrostVote, 0xF221, FanVotedSpeed_t,                                  Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_SabbathVote,             0xF222, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_CompressorStartUpVote,   0xF223, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodEvapFanSpeed_GridVote,                0xF224, FanVotedSpeed_t,                                    Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
