...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_FreshFoodEvap_UnfilteredTemperatureInDegFx100,                0xF0C8, TemperatureDegFx100_t,               Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   ENTRY(Erd_FreshFoodEvap_FilteredTemperatureInDegFx100,                  0xF0D9, TemperatureDegFx100_t,               Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
