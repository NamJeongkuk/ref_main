...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_InternalBufferedUart,                          0xF103, I_BufferedUart_t *,                                 Swap_N, Io_None, Sub_N, Ram,      NotNv,                                    NotFault) \
   ENTRY(Erd_ExternalBufferedUart,                          0xF104, I_BufferedUart_t *,                                 Swap_N, Io_None, Sub_N, Ram,      NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_PushButtonSwitch,                              0xF202, bool,                                               Swap_N, Io_All,  Sub_N, Bsp,      NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_NvMetadata,                                    0xFCFE, AsyncDataSource_FlashBlockGroupMetadata_t,          Swap_N, Io_None, Sub_N, Nv,       NonVolatileDataSourceDefaultData_Zeros,   NotFault) \
