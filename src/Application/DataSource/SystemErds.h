...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_ConvertibleCompartmentDamperPosition_PulldownVote,                   0xF32B, DamperVotedPosition_t,        Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_ConvertibleCompartmentDamperPosition_GridVote,                       0xF32C, DamperVotedPosition_t,        Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ENTRY(Erd_SealedSystemValvePosition_ResolvedVote,        0xF32D, SealedSystemValveVotedPosition_t,                   Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_SealedSystemValvePosition_WinningVoteErd,      0xF32E, WinningVoteErd_t,                                   Swap_Yes, Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_SealedSystemValvePosition_FactoryVote,         0xF32F, SealedSystemValveVotedPosition_t,                   Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_SealedSystemValvePosition_PowerUpVote,         0xF330, SealedSystemValveVotedPosition_t,                   Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_SealedSystemValvePosition_DefrostVote,         0xF331, SealedSystemValveVotedPosition_t,                   Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_SealedSystemValvePosition_GridVote,            0xF332, SealedSystemValveVotedPosition_t,                   Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
