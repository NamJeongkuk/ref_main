...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_DeliFanSpeed_FeaturePanVote,                   0xF251, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DeliFanSpeed_GridVote,                         0xF252, FanVotedSpeed_t,                                    Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
   ...
   ENTRY(Erd_DeliDamperPosition_FeaturePanVote,             0xF364, DamperVotedPosition_t,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DeliDamperPosition_GridVote,                   0xF365, DamperVotedPosition_t,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
