...
#define ERD_TABLE(ENTRY)  \
   ...
   ENTRY(Erd_FreezerEvapFanSpeed_FreezerIceRateVote,        0xF233, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_FeaturePanVote,            0xF234, FanVotedSpeed_t,                                    Swap_Range,   Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreezerEvapFanSpeed_GridVote,                  0xF235, FanVotedSpeed_t,                                    Swap_Range_E, Io_None, Sub_N, Ram,                NotNv,                                                       NotNv,         NotFault) \
   \
