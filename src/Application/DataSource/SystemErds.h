...
\
   ...
   \
   ENTRY(Erd_LeftSideFreshFoodDoorStatus_SabbathOverrideRequest,             0xF465, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_LeftSideFreshFoodDoorStatus_SabbathOverrideValue,               0xF466, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_LeftSideFreshFoodDoorStatus_TestingOverrideRequest,             0xF467, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_LeftSideFreshFoodDoorStatus_TestingOverrideValue,               0xF468, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ENTRY(Erd_ConvertibleCompartmentStatus_SabbathOverrideRequest,            0xF469, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_ConvertibleCompartmentStatus_SabbathOverrideValue,              0xF46A, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_ConvertibleCompartmentStatus_TestingOverrideRequest,            0xF46B, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_ConvertibleCompartmentStatus_TestingOverrideValue,              0xF46C, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ENTRY(Erd_BottomFreezerDrawerStatus_SabbathOverrideRequest,               0xF46D, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_BottomFreezerDrawerStatus_SabbathOverrideValue,                 0xF46E, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_BottomFreezerDrawerStatus_TestingOverrideRequest,               0xF46F, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_BottomFreezerDrawerStatus_TestingOverrideValue,                 0xF470, bool,                              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ENTRY(Erd_DimmableLight1PercentLevelRequest,             0xF471, PercentageDutyCycle_t,                              Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DimmableLight1PercentLevelStatus,              0xF472, PercentageDutyCycle_t,                              Swap_No,  Io_None, Sub_N, NvUserSetting,          NonVolatileDataSourceDefaultData_MaxLightBrightness,         1,             NotFault) \
   ENTRY(Erd_DimmableLight1Configuration,                   0xF473, UserAllowableInteriorLightingBitmap_t,              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DimmableLight2PercentLevelRequest,             0xF474, PercentageDutyCycle_t,                              Swap_No,  Io_None, Sub_Y, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_DimmableLight2PercentLevelStatus,              0xF475, PercentageDutyCycle_t,                              Swap_No,  Io_None, Sub_N, NvUserSetting,          NonVolatileDataSourceDefaultData_MaxLightBrightness,         1,             NotFault) \
   ENTRY(Erd_DimmableLight2Configuration,                   0xF476, UserAllowableInteriorLightingBitmap_t,              Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
   ENTRY(Erd_FreshFoodBackLightUserAllowableState,          0xF477, UserAllowableInteriorLightState_t,                  Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreshFoodTopLightUserAllowableState,           0xF478, UserAllowableInteriorLightState_t,                  Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreezerBackLightUserAllowableState,            0xF479, UserAllowableInteriorLightState_t,                  Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   ENTRY(Erd_FreezerTopLightUserAllowableState,             0xF47A, UserAllowableInteriorLightState_t,                  Swap_No,  Io_None, Sub_N, Ram,                    NotNv,                                                       NotNv,         NotFault) \
   \
