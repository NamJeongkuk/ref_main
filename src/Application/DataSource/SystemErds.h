...
#define ERD_TABLE(ENTRY)  \
   ...
   \
   ENTRY(Erd_TimeAcceleration_Enable,                       0xF187, bool,                                               Swap_N, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_TimeAcceleration_Ticks,                        0xF188, uint32_t,                                           Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_TimeAcceleration_CompleteSignal,               0xF189, Signal_t,                                           Swap_N, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ENTRY(Erd_ResetAndCountDefrostCompressorOnTimeCountsAndDoorAccelerationsRequestSignal, 0xF18A, Signal_t,             Swap_N, Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   \
   ENTRY(Erd_Ambient_FilteredTemperatureOverrideRequest,                     0xF1A5, bool,                              Swap_N, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_Ambient_FilteredTemperatureOverrideValueInDegFx100,             0xF1A6, TemperatureDegFx100_t,             Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_Ambient_FilteredTemperatureResolvedInDegFx100,                  0xF1A7, TemperatureDegFx100_t,             Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ENTRY(Erd_AluminumMoldIceMaker_FilteredTemperatureOverrideRequest,        0xF1A8, bool,                              Swap_N, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_AluminumMoldIceMaker_FilteredTemperatureOverrideValueInDegFx100,0xF1A9, TemperatureDegFx100_t,             Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_AluminumMoldIceMaker_FilteredTemperatureResolvedInDegFx100,     0xF1AA, TemperatureDegFx100_t,             Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   ENTRY(Erd_FeelerArmPosition,                             0xF1C9, FeelerArmPosition_t,                                Swap_N, Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   \
   ENTRY(Erd_UseMinimumReadyToDefrostTime,                  0xF20D, bool,                                               Swap_N, Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   ...
   \
   ENTRY(Erd_AluminumMoldIceMakerHeater_ResolvedVote,       0xF220, HeaterVotedState_t,                                 Swap_N, Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_AluminumMoldIceMakerHeater_WinningVoteErd,     0xF221, WinningVoteErd_t,                                   Swap_Y, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_AluminumMoldIceMakerHeater_FactoryVote,        0xF222, HeaterVotedState_t,                                 Swap_N, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   ENTRY(Erd_AluminumMoldIceMakerHeater_IceMakerVote,       0xF223, HeaterVotedState_t,                                 Swap_N, Io_None, Sub_N, Ram,                    NotNv,                                    NotFault) \
   \
   ...
   \
   ENTRY(Erd_Gpio_PWM_VAR_01,                               0xF440, bool,                                               Swap_N, Io_None, Sub_N, Bsp,                    NotNv,                                    NotFault) \
   ...
   ENTRY(Erd_FactoryModeActive,                             0xF801, bool,                                               Swap_N, Io_None, Sub_Y, Ram,                    NotNv,                                    NotFault) \
   \
