   ...
   I_DataModel_t *dataModel)
{
   ...
   CrossAmbientOffsetCalculator_Init(
      ...
      dataModel,
      PersonalityParametricData_Get(dataModel)->adjustedSetpointData->featurePanAdjustedSetpointData->crossAmbientAsFreshFoodOffsetData,
      &convertibleCompartmentAsFreshFoodOffsetCalculatorConfig);

   CrossAmbientOffsetCalculator_Init(
      &instance->_private.convertibleCompartmentAsFreezerOffsetCalculator,
      dataModel,
      PersonalityParametricData_Get(dataModel)->adjustedSetpointData->featurePanAdjustedSetpointData->crossAmbientAsFreezerOffsetData,
