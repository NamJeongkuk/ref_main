...
#define ERD_RESOLVER_TABLE(ENTRY)                                                                                                                                                                                                               \
   ENTRY(convertibleCompartmentSetPoint, Erd_ConvertibleCompartmentSetpoint_WinningVoteErd, Erd_ConvertibleCompartmentSetpoint_ResolvedVote, (Erd_ConvertibleCompartmentSetpoint_UserVote - Erd_ConvertibleCompartmentSetpoint_WinningVoteErd)) \
   ENTRY(freezerSetPoint, Erd_FreezerSetpoint_WinningVoteErd, Erd_FreezerSetpoint_ResolvedVote, (Erd_FreezerSetpoint_UserVote - Erd_FreezerSetpoint_WinningVoteErd))                                                                            \
   ENTRY(freshFoodSetPoint, Erd_FreshFoodSetpoint_WinningVoteErd, Erd_FreshFoodSetpoint_ResolvedVote, (Erd_FreshFoodSetpoint_UserVote - Erd_FreshFoodSetpoint_WinningVoteErd))
