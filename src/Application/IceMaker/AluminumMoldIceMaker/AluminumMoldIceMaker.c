...
static bool IceMakerTemperatureIsReadyToHarvest(AluminumMoldIceMaker_t *instance)
{
   ...
   return (temperature < instance->_private.iceMakerParametricData->maxHarvestTemperatureInDegFx100);
}
...
static void DataModelChanged(void *context, const void *args)
{
   ...
   else if(erd == instance->_private.config->iceMakerFilteredTemperatureInDegFx100Erd)
   {
      ...
      if(*temperature < instance->_private.iceMakerParametricData->maxHarvestTemperatureInDegFx100)
      {
