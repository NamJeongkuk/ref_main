...
#define __R_BSP_ATTRIB_SECTION_CHANGE_V(section_name) \
   R_BSP_PRAGMA(location = #section_name)             \
   __no_init
...
#else /* BSP_CFG_RTOS_USED != 4*/
#define R_BSP_PRAGMA_INTERRUPT(function_name, vector)   \
   R_BSP_PRAGMA(interrupt function_name(vect = vector)) \
   extern void function_name(void);
#define R_BSP_PRAGMA_STATIC_INTERRUPT(function_name, vector) \
   R_BSP_PRAGMA(interrupt function_name(vect = vector))      \
   static void function_name(void);

#define R_BSP_PRAGMA_INTERRUPT_FUNCTION(function_name) \
   R_BSP_PRAGMA(interrupt function_name)               \
   extern void function_name(void);
#endif /* BSP_CFG_RTOS_USED */

#define R_BSP_PRAGMA_STATIC_INTERRUPT_FUNCTION(function_name) \
   R_BSP_PRAGMA(interrupt function_name)                      \
   static void function_name(void);
...
/* Fast */
#define R_BSP_PRAGMA_FAST_INTERRUPT(function_name, vector)    \
   R_BSP_PRAGMA(interrupt function_name(vect = vector, fint)) \
   extern void function_name(void);
#define R_BSP_PRAGMA_STATIC_FAST_INTERRUPT(function_name, vector) \
   R_BSP_PRAGMA(interrupt function_name(vect = vector, fint))     \
   static void function_name(void);

#define R_BSP_PRAGMA_FAST_INTERRUPT_FUNCTION(function_name) \
   R_BSP_PRAGMA(interrupt function_name(fint))              \
   extern void function_name(void);
#define R_BSP_PRAGMA_STATIC_FAST_INTERRUPT_FUNCTION(function_name) \
   R_BSP_PRAGMA(interrupt function_name(fint))                     \
   static void function_name(void);
...
#else /* BSP_CFG_RTOS_USED != 4 */
#define R_BSP_PRAGMA_INTERRUPT_DEFAULT(function_name) \
   R_BSP_PRAGMA(interrupt function_name)              \
   extern void function_name(void);

#define R_BSP_PRAGMA_STATIC_INTERRUPT_DEFAULT(function_name) \
   R_BSP_PRAGMA(interrupt function_name)                     \
   static void function_name(void);
#endif /* BSP_CFG_RTOS_USED */
...
#define R_BSP_PRAGMA_STATIC_INTERRUPT(function_name, vector) extern void function_name(void) __attribute__((interrupt(R_BSP_SECNAME_INTVECTTBL, vector), used));

#define R_BSP_PRAGMA_INTERRUPT_FUNCTION(function_name) extern void function_name(void) __attribute__((interrupt));
#define R_BSP_PRAGMA_STATIC_INTERRUPT_FUNCTION(function_name) extern void function_name(void) __attribute__((interrupt, used));

#define R_BSP_ATTRIB_INTERRUPT extern /* only this one because __attribute__((interrupt)) prevents GNURX from generating vector */
#define R_BSP_ATTRIB_STATIC_INTERRUPT extern /* only this one because __attribute__((interrupt, used)) prevents GNURX from generating vector */
...
/* Standard */
#define R_BSP_PRAGMA_INTERRUPT(function_name, vect) \
   R_BSP_PRAGMA(vector = vect)                      \
   extern __interrupt void function_name(void);
#define R_BSP_PRAGMA_STATIC_INTERRUPT(function_name, vect) \
   R_BSP_PRAGMA(vector = vect)                             \
...
/* Fast */
#define R_BSP_PRAGMA_FAST_INTERRUPT(function_name, vect) \
   R_BSP_PRAGMA(vector = vect)                           \
   extern __fast_interrupt void function_name(void);
#define R_BSP_PRAGMA_STATIC_FAST_INTERRUPT(function_name, vect) \
   R_BSP_PRAGMA(vector = vect)                                  \
...
#define R_BSP_PRAGMA_INLINE(function_name) \
   R_BSP_PRAGMA(inline function_name)      \
   extern
#define R_BSP_PRAGMA_STATIC_INLINE(function_name) \
   R_BSP_PRAGMA(inline function_name)             \
   static
...
#define R_BSP_PRAGMA_INLINE_ASM(function_name) \
   R_BSP_PRAGMA(inline_asm function_name)      \
   extern
#define R_BSP_PRAGMA_STATIC_INLINE_ASM(function_name) \
   R_BSP_PRAGMA(inline_asm function_name)             \
   static
...
#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, bf29, bf30, bf31) \
   struct                                                                                                                                                                                                                        \
   {                                                                                                                                                                                                                             \
...
#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_1(bf0) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(            \
      bf0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_2(bf0, bf1) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                 \
      bf0, bf1, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_3(bf0, bf1, bf2) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                      \
      bf0, bf1, bf2, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_4(bf0, bf1, bf2, bf3) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                           \
      bf0, bf1, bf2, bf3, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_5(bf0, bf1, bf2, bf3, bf4) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                \
      bf0, bf1, bf2, bf3, bf4, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_6(bf0, bf1, bf2, bf3, bf4, bf5) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                     \
      bf0, bf1, bf2, bf3, bf4, bf5, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_7(bf0, bf1, bf2, bf3, bf4, bf5, bf6) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                          \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_8(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                               \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_9(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                    \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_10(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                          \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_11(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_12(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                      \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_13(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                            \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_14(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                  \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_15(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                        \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_16(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                              \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_17(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                    \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)
...
#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_18(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                          \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)
...
#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_19(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)
...
#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_20(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                      \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)
...
#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_21(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                            \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_22(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                  \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_23(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                        \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_24(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                              \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_25(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                                    \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_26(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                                          \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_27(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                                                \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_28(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                                                      \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_29(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                                                            \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_30(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, bf29) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                                                                  \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, bf29, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_31(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, bf29, bf30) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                                                                        \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, bf29, bf30, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT_32(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, bf29, bf30, bf31) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_LEFT(                                                                                                                                                                                              \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, bf29, bf30, bf31)

/* ---------- bit_order=right ---------- */
#if defined(__CCRX__)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, bf17, bf18, bf19, bf20, bf21, bf22, bf23, bf24, bf25, bf26, bf27, bf28, bf29, bf30, bf31) \
   struct                                                                                                                                                                                                                         \
   {                                                                                                                                                                                                                              \
...
#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT_11(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT(                                                                \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT_12(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT(                                                                      \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT_13(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT(                                                                            \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT_14(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT(                                                                                  \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT_15(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT(                                                                                        \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT_16(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT(                                                                                              \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)

#define R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT_17(bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16) \
   R_BSP_ATTRIB_STRUCT_BIT_ORDER_RIGHT(                                                                                                    \
      bf0, bf1, bf2, bf3, bf4, bf5, bf6, bf7, bf8, bf9, bf10, bf11, bf12, bf13, bf14, bf15, bf16, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0, uint8_t : 0)
