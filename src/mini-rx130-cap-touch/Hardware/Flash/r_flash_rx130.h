...
typedef enum _flash_block_address
{
    ...
    FLASH_CF_BLOCK_INVALID = 0xFFFDFC00,    //   '5' parts 128KB ROM
#endif
...
extern const flash_block_address_t g_flash_BlockAddresses[FLASH_NUM_BLOCKS_DF];
...
/******************************************************************************
 Flash Type 1 specific implementations
******************************************************************************/
