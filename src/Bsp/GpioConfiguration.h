...
#define GPIO_TABLE(ENTRY) \
   ...
   ENTRY(Erd_BspGpio_HTR_00,              GpioDirection_Output, 0,  0,  GpioPullUp_Disable, GpioDriveCapacity_Normal, PortE, 6,  NonInverted) \
   ENTRY(Erd_BspGpio_HTR_01,              GpioDirection_Output, 0,  0,  GpioPullUp_Disable, GpioDriveCapacity_Normal, PortJ, 7,  NonInverted) \
   ENTRY(Erd_BspGpio_HTR_02,              GpioDirection_Output, 0,  0,  GpioPullUp_Disable, GpioDriveCapacity_Normal, Port1, 3,  NonInverted) \
   ENTRY(Erd_BspGpio_HTR_03,              GpioDirection_Output, 0,  0,  GpioPullUp_Disable, GpioDriveCapacity_Normal, PortJ, 6,  NonInverted) \
   ENTRY(Erd_BspGpio_HTR_04,              GpioDirection_Output, 0,  0,  GpioPullUp_Disable, GpioDriveCapacity_Normal, Port0, 7,  NonInverted) \
