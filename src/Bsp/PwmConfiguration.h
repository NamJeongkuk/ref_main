...
#define PWM_TABLE(ENTRY) \
   ...
   ENTRY(Erd_BspPwm_PWM_200_00,    200_00,         1,            H,    1,   0x05,         tmo,  0,           B,                      SetTimerConfig) \
   ENTRY(Erd_BspPwm_PWM_200_01,    200_01,         1,            1,    7,   0x05,         tmo,  1,           B,                      SetTimerConfig) \
   ENTRY(Erd_BspPwm_PWM_200_02,    200_02,         1,            C,    7,   0x05,         tmo,  2,           B,                      SetTimerConfig) \
   ENTRY(Erd_BspPwm_PWM_200_03,    200_03,         1,            5,    5,   0x05,         tmo,  3,           B,                      SetTimerConfig) \
