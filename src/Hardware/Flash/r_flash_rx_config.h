 ...
 * function. 
 */
#define FLASH_CFG_DATA_FLASH_BGO   (1)      // Not supported on RX110/23T (no data flash)
 ...
 * segment in ROM. See section 2.14 in the App Note.
 */
#define FLASH_CFG_CODE_FLASH_RUN_FROM_ROM   (1) // Flash type 3 only
