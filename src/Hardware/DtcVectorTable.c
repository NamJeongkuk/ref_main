...
void *const dtcVectorTable[] __attribute__((section(".dtcVectorTable"))) = {
   ...
   DUMMY_ADDR, /*  58 INTB+00E8h       CMPB0       */
   DUMMY_ADDR, /*  59 INTB+00ECh       CMPB1       */
   ...
   DUMMY_ADDR, /* 142 INTB+0238h                   */
   DUMMY_ADDR, /* 143 INTB+023Ch                   */
   DUMMY_ADDR, /* 144 INTB+0240h                   */
   DUMMY_ADDR, /* 145 INTB+0244h                   */
   DUMMY_ADDR, /* 146 INTB+0248h                   */
   DUMMY_ADDR, /* 147 INTB+024Ch                   */
   DUMMY_ADDR, /* 148 INTB+0250h                   */
   DUMMY_ADDR, /* 149 INTB+0254h                   */
   DUMMY_ADDR, /* 150 INTB+0258h                   */
   DUMMY_ADDR, /* 151 INTB+025Ch                   */
   DUMMY_ADDR, /* 152 INTB+0260h                   */
   DUMMY_ADDR, /* 153 INTB+0264h                   */
   ...
   (void *)&tmr0CompareMatchA, /* 174 INTB+02B8h       TMR0_CMIA0       */
   DUMMY_ADDR, /* 175 INTB+02BCh       CMIB0       */
   DUMMY_ADDR, /* 176 INTB+02C0h                   */
   (void *)&tmr1CompareMatchA, /* 177 INTB+02C4h       TMR1_CMIA1       */
   DUMMY_ADDR, /* 178 INTB+02C8h       CMIB1       */
   DUMMY_ADDR, /* 179 INTB+02CCh                   */
   (void *)&tmr2CompareMatchA, /* 180 INTB+02D0h       TMR2_CMIA2       */
   DUMMY_ADDR, /* 181 INTB+02D4h       CMIB2       */
   DUMMY_ADDR, /* 182 INTB+02D8h                   */
   (void *)&tmr3CompareMatchA, /* 183 INTB+02DCh       TMR3_CMIA3       */
   DUMMY_ADDR, /* 184 INTB+02E0h       CMIB3       */
   DUMMY_ADDR, /* 185 INTB+02E4h                   */
   DUMMY_ADDR, /* 186 INTB+02E8h                   */
   DUMMY_ADDR, /* 187 INTB+02ECh                   */
   DUMMY_ADDR, /* 188 INTB+02F0h                   */
   DUMMY_ADDR, /* 189 INTB+02F4h                   */
   DUMMY_ADDR, /* 190 INTB+02F8h                   */
   DUMMY_ADDR, /* 191 INTB+02FCh                   */
   DUMMY_ADDR, /* 192 INTB+0300h                   */
   DUMMY_ADDR, /* 193 INTB+0304h                   */
   DUMMY_ADDR, /* 194 INTB+0308h                   */
   DUMMY_ADDR, /* 195 INTB+030Ch                   */
   DUMMY_ADDR, /* 196 INTB+0310h                   */
   DUMMY_ADDR, /* 197 INTB+0314h                   */
   DUMMY_ADDR, /* 198 INTB+0318h       DMAC0I      */
   DUMMY_ADDR, /* 199 INTB+031Ch       DMAC1I      */
   DUMMY_ADDR, /* 200 INTB+0320h       DMAC2I      */
   DUMMY_ADDR, /* 201 INTB+0324h       DMAC3I      */
   ...
   DUMMY_ADDR, /* 215 INTB+035Ch       SCI0_RXI0   */
   DUMMY_ADDR, /* 216 INTB+0360h       SCI0_TXI0   */
   DUMMY_ADDR, /* 217 INTB+0364h                   */
   DUMMY_ADDR, /* 218 INTB+0368h                   */
   (void *)&uart1Receive, /* 219 INTB+036Ch       SCI1_RXI1   */
   (void *)&uart1Transmit, /* 220 INTB+0370h       SCI1_TXI1   */
   DUMMY_ADDR, /* 221 INTB+0374h                   */
   DUMMY_ADDR, /* 222 INTB+0378h                   */
   (void *)&uart5Receive, /* 223 INTB+037Ch       SCI5_RXI5   */
   ...
   DUMMY_ADDR, /* 232 INTB+03A0h       SCI8_TXI8   */
   DUMMY_ADDR, /* 233 INTB+03A4h                   */
   DUMMY_ADDR, /* 234 INTB+03A8h                   */
   (void *)&uart9Receive, /* 235 INTB+03ACh       SCI9_RXI9   */
   (void *)&uart9Transmit, /* 236 INTB+03B0h       SCI9_TXI9   */
   DUMMY_ADDR, /* 237 INTB+03B4h                   */
   DUMMY_ADDR, /* 238 INTB+03B8h                   */
   DUMMY_ADDR, /* 239 INTB+03BCh       SCI12_RXI12 */
   DUMMY_ADDR, /* 240 INTB+03C0h       SCI12_TXI12 */
   ...
   DUMMY_ADDR, /* 247 INTB+03DCh       RIIC0_RXI0  */
   DUMMY_ADDR, /* 248 INTB+03E0h       RIIC0_TXI0  */
