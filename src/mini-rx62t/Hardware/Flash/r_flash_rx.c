...
* Return Value : see called function
***********************************************************************************************************************/
flash_err_t R_FLASH_Erase(flash_block_address_t block_start_address, uint32_t num_blocks) __attribute__((section(".flashCode")));
...
* Return Value : see called function
***********************************************************************************************************************/
flash_err_t R_FLASH_BlankCheck(uint32_t address, uint32_t num_bytes, flash_res_t *result) __attribute__((section(".flashCode")));
...
* Return Value : see called function
***********************************************************************************************************************/
flash_err_t R_FLASH_Write(uint32_t src_address, uint32_t dest_address, uint32_t num_bytes) __attribute__((section(".flashCode")));
...
* Return Value : see called function
***********************************************************************************************************************/
flash_err_t R_FLASH_Control(flash_cmd_t cmd, void *pcfg) __attribute__((section(".flashCode")));
...
***********************************************************************************************************************/
inline uint32_t R_FLASH_GetVersion(void) __attribute__((section(".flashCode"))) __attribute__((always_inline));
inline uint32_t R_FLASH_GetVersion(void)
{
...
******************************************************************************/
flash_err_t flash_lock_state(flash_states_t new_state) __attribute__((section(".flashCode")));
...
* Return Value : none
******************************************************************************/
void flash_release_state(void) __attribute__((section(".flashCode")));
...
***********************************************************************************************************************/
bool flash_softwareLock(int32_t *const plock) __attribute__((section(".flashCode")));
bool flash_softwareLock(int32_t *const plock)
{
   ...
   __builtin_rx_xchg((int *)&is_locked, (int *)plock);
...
***********************************************************************************************************************/
bool flash_softwareUnlock(int32_t *const plock) __attribute__((section(".flashCode")));
