...
__attribute__((unused)) static rom_block_sizes_t g_flash_RomBlockSizes[NUM_BLOCK_TABLE_ENTRIES] = {
...
#error "ERROR - Flash API - FCLK on RX62T must be between 8MHz and 50MHz!"
#endif
