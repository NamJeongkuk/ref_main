...
void BSC_BUSERR(void) __attribute__((weak, alias("Default_Handler")));
void FCU_FIFERR(void) __attribute__((weak, alias("Ignore")));
void FCU_FRDYI(void) __attribute__((weak, alias("Default_Handler")));
void ICU_SWINT(void) __attribute__((weak, alias("Default_Handler")));
...
void ctsu_ctsuwr_isr(void) __attribute__((weak, alias("Ignore")));
void ctsu_ctsurd_isr(void) __attribute__((weak, alias("Ignore")));
void ctsu_ctsufn_isr(void) __attribute__((weak, alias("Ignore")));
...
const fp relocatableVectorTable[] __attribute__((section(".relocatableVectorTable"))) = {
   ...
   ctsu_ctsuwr_isr, // CTSU CTSUWR 60 0x00F0 (RX231)
   ctsu_ctsurd_isr, // CTSU CTSURD 61 0x00F4 (RX231)
   ctsu_ctsufn_isr, // CTSU CTSUFN 62 0x00F8 (RX231)
