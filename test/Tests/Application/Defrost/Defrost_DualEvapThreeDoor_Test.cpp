...
TEST(Defrost_DualEvapThreeDoor, ShouldSetCabinetFilteredTemperatureTooWarmOnPowerUpErdToFalseWhenFreshFoodEvapFilteredTemperatureIsAtDefrostTerminationTemperatureAndThermistorIsValid)
{
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNextDefrostTypeOverrideToFullIfEepromClearedOnPowerUp)
{
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNextDefrostTypeOverrideToFullIfCabinetTooWarmOnPowerUp)
{
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNextDefrostTypeOverrideToFullIfDefrostWasDisabledBeforePowerUp)
{
   Given NextDefrostTypeOverrideIs(DefrostType_SecondaryOnly);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetCurrentDefrostTypeToSecondaryOnlyDefrostOnIdleExitWhenNextDefrostTypeOverrideIsDontCareAndNumberOfSecondaryDefrostsIsLessThanNumberOfSecondaryOnlyDefrostsBeforeFullDefrost)
{
   Given NextDefrostTypeOverrideIs(DefrostType_DontCare);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetCurrentDefrostTypeToFullOnIdleExitWhenNextDefrostTypeOverrideIsDontCareAndNumberOfSecondaryDefrostIsGreaterThanNumberOfSecondaryOnlyDefrostsBeforeFullDefrost)
{
   Given NextDefrostTypeOverrideIs(DefrostType_DontCare);
   GivenNumberOfSecondaryOnlyDefrostsIs(defrostData.idleData.numberOfSecondaryOnlyDefrostsBeforeFullDefrost + 1);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetCurrentDefrostTypeToFullOnIdleExitWhenNextDefrostTypeOverrideIsDontCareAndNumberOfSecondaryDefrostIsEqualToNumberOfSecondaryOnlyDefrostsBeforeFullDefrost)
{
   Given NextDefrostTypeOverrideIs(DefrostType_DontCare);
   GivenNumberOfSecondaryOnlyDefrostsIs(defrostData.idleData.numberOfSecondaryOnlyDefrostsBeforeFullDefrost);
   Given CurrentDefrostTypeIs(DefrostType_SecondaryOnly);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetCurrentDefrostTypeToNextDefrostTypeOverrideOnIdleExitWhenNextDefrostTypeIsSecondaryOnly)
{
   Given NextDefrostTypeOverrideIs(DefrostType_SecondaryOnly);
   Given CurrentDefrostTypeIs(DefrostType_Full);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNextDefrostTypeOverrideToDontCareOnIdleExitWhenNextDefrostTypeIsSecondaryOnly)
{
   Given NextDefrostTypeOverrideIs(DefrostType_SecondaryOnly);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetCurrentDefrostTypeToNextDefrostTypeOverrideAndIncrementNumberOfSecondaryDefrostsOnIdleExitWhenNextDefrostTypeIsSecondaryOnlyOnIdleExitViaPrechillTestRequest)
{
   Given NextDefrostTypeOverrideIs(DefrostType_DontCare);
   Given CurrentDefrostTypeIs(DefrostType_Full);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetCurrentDefrostTypeToNextDefrostTypeOverrideAndIncrementNumberOfSecondaryDefrostsOnIdleExitWhenNextDefrostTypeIsSecondaryOnlyOnIdleExitViaDefrostTestRequest)
{
   Given NextDefrostTypeOverrideIs(DefrostType_DontCare);
   Given CurrentDefrostTypeIs(DefrostType_Full);
   GivenNumberOfSecondaryOnlyDefrostsIs(0);
...
TEST(Defrost_DualEvapThreeDoor, ShouldIncrementNumberOfSecondaryOnlyDefrostsOnIdleExitWhenNextDefrostTypeIsSecondaryOnlyOnIdleExit)
{
   Given NextDefrostTypeOverrideIs(DefrostType_SecondaryOnly);
   GivenNumberOfSecondaryOnlyDefrostsIs(0);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNumberOfSecondaryOnlyDefrostsToZeroOnIdleExitWhenNextDefrostTypeIsNotSecondaryOnlyOnIdleExit)
{
...
TEST(Defrost_DualEvapThreeDoor, ShouldIncrementNumberOfSecondaryOnlyDefrostsOnIdleExitWhenNextDefrostTypeIsDontCareAndNumberOfSecondaryDefrostsIsLessThanNumberOfSecondaryOnlyDefrostsBeforeFullDefrostOnIdleExit)
{
   Given NextDefrostTypeOverrideIs(DefrostType_DontCare);
   GivenNumberOfSecondaryOnlyDefrostsIs(0);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNumberOfSecondaryOnlyDefrostsToZeroOnIdleExitWhenNextDefrostTypeIsDontCareAndNumberOfSecondaryDefrostsIsGreaterThanNumberOfSecondaryOnlyDefrostsBeforeFullDefrostOnIdleExit)
{
   Given NextDefrostTypeOverrideIs(DefrostType_DontCare);
   GivenNumberOfSecondaryOnlyDefrostsIs(20);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSkipDefrostTypeDeterminationOnIdleExitWhenDefrostIsDisabled)
{
   Given NextDefrostTypeOverrideIs(DefrostType_SecondaryOnly);
   Given CurrentDefrostTypeIs(DefrostType_Full);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotSkipDefrostTypeDeterminationOnIdleExitWhenDefrostIsDisabledAndThenEnabled)
{
   Given NextDefrostTypeOverrideIs(DefrostType_SecondaryOnly);
   Given CurrentDefrostTypeIs(DefrostType_Full);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNumberOfSecondaryOnlyDefrostsOnInit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNumberOfSecondaryOnlyDefrostsToEnhancedSabbathDataWhenEnhancedSabbathIsEnabledOnInit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNumberOfSecondaryOnlyDefrostsToEnhancedSabbathDataWhenSabbathIsEnabledOnInit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetNumberOfSecondaryOnlyDefrostsToIdleAbnormalDataWhenFreezerDefrostWasAbnormalOnInit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
   GivenLastFreezerDefrostWasAbnormal();
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldUpdateNumberOfSecondaryOnlyDefrostsBeforeFullDefrostWhenEnhancedSabbathModeIsEnabledOnIdleExit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
...
TEST(Defrost_DualEvapThreeDoor, ShouldUpdateNumberOfSecondaryOnlyDefrostsBeforeFullDefrostWhenEnhancedSabbathModeIsDisabledOnIdleExit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
   GivenEnhancedSabbathModeIs(ENABLED);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldUpdateNumberOfSecondaryOnlyDefrostsBeforeFullDefrostWhenSabbathModeIsEnabledOnIdleExit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
...
TEST(Defrost_DualEvapThreeDoor, ShouldUpdateNumberOfSecondaryOnlyDefrostsBeforeFullDefrostWhenSabbathModeIsDisabledOnIdleExit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
   GivenEnhancedSabbathModeIs(ENABLED);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldUpdateNumberOfSecondaryOnlyDefrostsBeforeFullDefrostWhenFreezerDefrostIsAbnormalOnIdleExit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
   GivenLastFreezerDefrostWasNormal();
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldUpdateNumberOfSecondaryOnlyDefrostsBeforeFullDefrostWhenFreezerDefrostIsNormalOnIdleExit)
{
   GivenNumberOfSecondaryOnlyDefrostsBeforeAFullDefrostIs(10);
   GivenLastFreezerDefrostWasAbnormal();
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Idle);
...
TEST(Defrost_DualEvapThreeDoor, ShouldTransitionToIdleAfterPostDwellTimeHasPassedForSecondaryOnlyDefrost)
{
   Given CurrentDefrostTypeIs(DefrostType_SecondaryOnly);
...
TEST(Defrost_DualEvapThreeDoor, ShouldExitPostDwellAndGoToIdleAfterFreshFoodOnlyPostDwellExitTimeIfPostDwellExitTimeIsFreshFoodOnly)
{
   Given CurrentDefrostTypeIs(DefrostType_SecondaryOnly);
   GivenCabinetIsNotTooWarmOnPowerUp();
   And DefrostStateIs(DefrostState_Dwell);
...
TEST(Defrost_DualEvapThreeDoor, ShouldExitOnHeaterEntryStateAndTurnOnTheFreshFoodAndFreezerDefrostHeaterAfterDefrostHeaterOnDelayTimerExpiredWhenDefrostTypeIsFull)
{
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_HeaterOnEntry);
   Given CurrentDefrostTypeIs(DefrostType_Full);
...
TEST(Defrost_DualEvapThreeDoor, ShouldExitOnHeaterEntryStateAndTurnOnTheFreezerDefrostHeaterAfterDefrostHeaterOnDelayTimerExpiredWhenDefrostTypeIsSecondaryOnly)
{
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_HeaterOnEntry);
   Given CurrentDefrostTypeIs(DefrostType_SecondaryOnly);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetInvalidEvaporatorThermistorDuringDefrostAndNotSetFreezerDefrostHeaterOnForMaxTimeFaultWhenTheFreezerEvapThermistorIsInvalidAndHasBeenDiscoveredAndMaxOnTimeReachesOnHeaterOn)
{
...
TEST(Defrost_DualEvapThreeDoor, ShouldClearInvalidEvaporatorThermistorDuringDefrostAndSetFreezerDefrostHeaterOnForMaxTimeFaultWhenFreshFoodEvapAndFreezerEvapThermistorsAreValidAndMaxOnTimeReachesOnHeaterOn)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   Given FreezerDefrostHeaterMaxOnTimeInMinutesIs(defrostData.heaterOnData.freezerHeater.defrostHeaterMaxOnTimeInMinutes);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotClearInvalidEvaporatorThermistorDuringDefrostWhenFreshFoodEvapThermistorIsInvalidAndFreezerEvapThermistorIsValidAndMaxOnTimeReachesOnHeaterOn)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   Given FreezerDefrostHeaterMaxOnTimeInMinutesIs(defrostData.heaterOnData.freezerHeater.defrostHeaterMaxOnTimeInMinutes);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSetInvalidEvaporatorThermistorDuringDefrostAndNotSetFreshFoodDefrostHeaterOnForMaxTimeFaultWhenTheFreshFoodThermistorIsInvalidAndHasBeenDiscoveredAndMaxOnTimeReachesOnHeaterOn)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
...
TEST(Defrost_DualEvapThreeDoor, ShouldClearInvalidEvaporatorThermistorDuringDefrostAndSetFreshFoodDefrostHeaterOnForMaxTimeFaultWhenFreshFoodEvapAndFreezerEvapThermistorsAreValidAndMaxOnTimeReachesOnHeaterOn)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodDefrostHeaterMaxOnTimeInMinutesIs(defrostData.heaterOnData.freshFoodHeater.defrostHeaterMaxOnTimeInMinutes);
   Given FreezerDefrostHeaterMaxOnTimeInMinutesIs(defrostData.heaterOnData.freezerHeater.defrostHeaterMaxOnTimeInMinutes);
...
TEST(Defrost_DualEvapThreeDoor, ShouldTransitionFromHeaterOnToDwellAfterFreshFoodHeaterIsOnForMaxTimeWhenDefrostTypeIsSecondaryOnly)
{
   GivenFreshFoodDefrostHeaterMaxOnTimeInMinutesIs(defrostData.heaterOnData.freshFoodHeater.defrostHeaterMaxOnTimeInMinutes);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldIncrementNumberOfFreshFoodAbnormalDefrostCycleCountAndSetFreshFoodDefrostWasAbnormalWhenFreshFoodHeaterOnTimeReachesAbnormalTime)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_SecondaryOnly);
...
TEST(Defrost_DualEvapThreeDoor, ShouldIncrementNumberOfFreshFoodAbnormalDefrostCycleCountJustOnce)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_SecondaryOnly);
   Given NumberOfFreshFoodAbnormalDefrostsIs(1);
   GivenFreshFoodDefrostHeaterMaxOnTimeInMinutesIs(defrostData.heaterOnData.freshFoodHeater.defrostHeaterMaxOnTimeInMinutes);
...
TEST(Defrost_DualEvapThreeDoor, ShouldClearFreshFoodDefrostWasAbnormalAndFreshFoodDefrostHeaterOnForMaxTimeFaultWhenFreshFoodEvaporatorReachesTerminationTemperatureAndFreshFoodHeaterOnTimeIsLessThanFreshFoodHeaterOnTimeToSetAbnormalDefrostAndFreshFoodEvaporatorThermistorIsValid)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotClearFreshFoodDefrostWasAbnormalAndFreshFoodDefrostHeaterOnForMaxTimeFaultWhenFreshFoodEvaporatorReachesTerminationTemperatureAndFreshFoodHeaterOnTimeIsLessThanFreshFoodHeaterOnTimeToSetAbnormalDefrostAndFreshFoodEvaporatorThermistorIsInvalid)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodEvapThermistorValidityIs(Invalid);
   Given LastFreshFoodDefrostWasAbnormal();
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotClearFreshFoodDefrostWasAbnormalWhenFreshFoodEvaporatorReachesTerminationTemperatureAndFreshFoodHeaterOnTimeIsEqualToFreshFoodHeaterOnTimeToSetAbnormalDefrostAndFreshFoodEvaporatorThermistorIsValid)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
   Given LastFreshFoodDefrostWasAbnormal();
...
TEST(Defrost_DualEvapThreeDoor, ShouldTurnOffFreshFoodDefrostHeaterWhenFreshFoodEvaporatorTemperatureReachesFreshFoodDefrostTerminationTemperatureAndFreshFoodEvaporatorThermistorIsValid)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
...
TEST(Defrost_DualEvapThreeDoor, ShouldClearInvalidEvaporatorThermistorDuringDefrostAndFreshFoodDefrostHeaterOnForMaxTimeFaultWhenTheThermistorIsValidAndTheThermistorTemperatureReachesHeaterOnTerminationTemperatureOnHeaterOn)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotTransitionToDwellUntilBothHeatersAreVotedOffAfterReachingTheirTerminationTemperaturesWithFreshFoodThenFreezerHeater)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotTransitionToDwellUntilBothHeatersAreVotedOffAfterReachingTheirTerminationTemperaturesWithFreezerThenFreshFoodHeater)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotTransitionToDwellUntilBothHeatersAreVotedOffAfterReachingTheirMaxOnTimesWithFreshFoodHeaterThenFreezerHeater)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotTransitionToDwellAfterFreezerDefrostHeaterReachesMaxOnTimeAndIsOffButFreshFoodHeaterIsStillOn)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldVoteHeatersOffOnExitWhenDefrostTestRequestIsToExitHeaterOnStateWhenDefrostTypeIsFull)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   FreezerDefrostHeaterVoteShouldBe(HeaterState_On, Vote_Care);
   FreshFoodDefrostHeaterVoteShouldBe(HeaterState_On, Vote_Care);
...
TEST(Defrost_DualEvapThreeDoor, ShouldVoteHeatersOffOnExitWhenDefrostTestRequestIsToExitHeaterOnStateWhenDefrostTypeIsSecondaryOnly)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_SecondaryOnly);
   FreezerDefrostHeaterVoteShouldBe(HeaterState_Off, Vote_DontCare);
   FreshFoodDefrostHeaterVoteShouldBe(HeaterState_On, Vote_Care);
   ConvertibleCompartmentDefrostHeaterVoteShouldBeDontCare();
...
TEST(Defrost_DualEvapThreeDoor, ShouldTurnOffDefrostHeaterAndIncrementFreshFoodDefrostCountAndTransitionToDwellStateWhenFreshFoodHeaterOnTimeReachesMaxOnTimeAndDefrostTypeIsSecondaryOnly)
{
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_SecondaryOnly);
...
TEST(Defrost_DualEvapThreeDoor, ShouldTurnOffDefrostHeaterAndIncrementFreshFoodAndFreezerDefrostCountsAndTransitionToDwellStateWhenFreshFoodHeaterOnTimeReachesMaxOnTimeAndDefrostTypeIsFull)
{
   GivenNumberOfSecondaryOnlyDefrostsIs(defrostData.idleData.numberOfSecondaryOnlyDefrostsBeforeFullDefrost);
   GivenDefrostIsInHeaterOnAndDefrostTypeIs(DefrostType_Full);
   Given NumberOfFreezerDefrostsIs(1);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSkipPostDwellIfAnyPrimaryEvaporatorTempIsAtOrBelowPostDwellPrimaryEvapExitTempAndCurrentDefrostTypeIsFull)
{
   Given CurrentDefrostTypeIs(DefrostType_Full);
...
TEST(Defrost_DualEvapThreeDoor, ShouldSkipPostDwellIfAnyPrimaryEvaporatorTempIsAtOrBelowPostDwellPrimaryEvapExitTempAndCurrentDefrostTypeIsSecondary)
{
   Given CurrentDefrostTypeIs(DefrostType_SecondaryOnly);
   GivenAllThermistorsValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldOnlyExitPostDwellWhenFreshFoodEvaporatorTempChangesToAtOrBelowPostDwellPrimaryEvapExitTemp)
{
   Given CurrentDefrostTypeIs(DefrostType_Full);
   GivenAllThermistorsValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldGoToHeaterOnEntryWhenFreezerEvapThermistorBecomesInvalidWhileInPrechillPrepAndFreezerEvapThermistorHasBeenDiscovered)
{
   Given FreezerThermistorValidityIs(Valid);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
   GivenFreezerEvapThermistorHasBeenDiscovered();
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotGoToHeaterOnEntryWhenFreezerEvapThermistorBecomesInvalidThenDiscoveredAndValidWhileInPrechillPrep)
{
   Given FreezerThermistorValidityIs(Valid);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotGoToHeaterOnEntryWhenFreezerEvapThermistorBecomesInvalidWhileInPrechillPrepAndFreezerEvapThermistorHasNotBeenDiscovered)
{
   Given FreezerThermistorValidityIs(Valid);
   Given FreezerEvaporatorThermistorValidityIs(Valid);
   GivenFreezerEvapThermistorHasNotBeenDiscovered();
...
TEST(Defrost_DualEvapThreeDoor, ShouldGoToHeaterOnEntryWhenFreshFoodEvapThermistorBecomesInvalidWhileInPrechillPrepAndFreshFoodEvapThermistorHasBeenDiscovered)
{
   Given FreshFoodThermistorValidityIs(Valid);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
   GivenFreshFoodEvapThermistorHasBeenDiscovered();
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotGoToHeaterOnEntryWhenFreshFoodEvapThermistorBecomesInvalidThenDiscoveredAndValidWhileInPrechillPrep)
{
   Given FreshFoodThermistorValidityIs(Valid);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldNotGoToHeaterOnEntryWhenFreshFoodEvapThermistorBecomesInvalidWhileInPrechillPrepAndFreshFoodEvapThermistorHasNotBeenDiscovered)
{
   Given FreshFoodThermistorValidityIs(Valid);
   GivenFreshFoodEvapThermistorValidityIs(Valid);
   GivenFreshFoodEvapThermistorHasNotBeenDiscovered();
...
TEST(Defrost_DualEvapThreeDoor, ShouldSkipThroughPrechillPrepToHeaterOnEntryIfFreshFoodEvapThermistorIsInvalidAndHasBeenDiscoveredWhenEnteringPrechillPrep)
{
   Given TimeThatPrechillConditionsAreMetInMinutesIs(ZeroMinutes);
   Given FilteredFreshFoodCabinetTemperatureIs(defrostData.prechillData.prechillFreshFoodMinTempInDegFx100 + 1);
   Given FreshFoodThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldGoToPrechillPrepIfFreshFoodThermistorIsInvalidAndHasNotBeenDiscoveredWhenEnteringPrechillPrep)
{
   Given TimeThatPrechillConditionsAreMetInMinutesIs(ZeroMinutes);
   Given FilteredFreshFoodCabinetTemperatureIs(defrostData.prechillData.prechillFreshFoodMinTempInDegFx100 + 1);
   Given FreshFoodThermistorValidityIs(Valid);
...
TEST(Defrost_DualEvapThreeDoor, ShouldGoToHeaterOnEntryWhenPrimaryEvaporatorTemperatureChangesToMeetExitConditionsWhileInPrechillState)
{
   Given FreezerEvaporatorThermistorValidityIs(Valid);
   Given FilteredFreezerEvapTemperatureIs(defrostData.prechillData.prechillPrimaryEvaporatorExitTemperatureInDegFx100 + 1);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Prechill);
...
TEST(Defrost_DualEvapThreeDoor, ShouldGoToHeaterOnEntryWhenPrimaryEvaporatorTemperatureChangesToBeEqualToTheExitConditionsWhileInPrechillState)
{
   Given FreezerEvaporatorThermistorValidityIs(Valid);
   Given FilteredFreezerEvapTemperatureIs(defrostData.prechillData.prechillPrimaryEvaporatorExitTemperatureInDegFx100 + 1);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Prechill);
...
TEST(Defrost_DualEvapThreeDoor, ShouldRemainInPrechillWhenPrimaryEvaporatorTemperatureChangesToBeMoreThanTheExitConditionsWhileInPrechillState)
{
   Given FreezerEvaporatorThermistorValidityIs(Valid);
   Given FilteredFreezerEvapTemperatureIs(defrostData.prechillData.prechillPrimaryEvaporatorExitTemperatureInDegFx100 + 1);
   Given DefrostIsInitializedAndStateIs(DefrostHsmState_Prechill);
