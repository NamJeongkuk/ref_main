...
static ReadyToDefrostImprovedConfiguration_t config = {
...
TEST_GROUP(ReadyToDefrostImproved)
{
   ...
   void GivenReadyToDefrostIsInitialized()
   {
      ...
      ReadyToDefrostImproved_Init(&instance, dataModel, &config, defrostData);
   }
...
TEST(ReadyToDefrostImproved, ShouldInitialize)
{
   GivenReadyToDefrostIsInitialized();
}

TEST(ReadyToDefrostImproved, ShouldInitializeIntoWaitingForMinimumTimeBetweenDefrostsWhenSystemIsWaitingToDefrostAndCompressorOnTimeIsLessThanMinimumTimeBetweenDefrostsOnInit)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenSystemConditionsAreSuchThatTimeBetweenDefrostsIsMinimumBecauseFreezerDefrostWasAbnormal();
   GivenWaitingToDefrostIs(true);
...
TEST(ReadyToDefrostImproved, ShouldInitializeIntoWaitingForRemainingTimeBetweenDefrostsWhenSystemIsWaitingToDefrostAndCompressorOnTimeIsEqualToMinimumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMaximumOnInit)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenSystemConditionsAreSuchThatTimeBetweenDefrostsIsMaximum();
   GivenWaitingToDefrostIs(true);
...
TEST(ReadyToDefrostImproved, ShouldInitializeIntoWaitingForRemainingTimeBetweenDefrostsWhenSystemIsWaitingToDefrostAndCompressorOnTimeIsGreaterThanMinimumTimeBetweenDefrostsButLessThanMaxAndTimeBetweenDefrostsIsMaximumOnInit)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
   GivenSystemConditionsAreSuchThatTimeBetweenDefrostsIsMaximum();
   GivenWaitingToDefrostIs(true);
...
TEST(ReadyToDefrostImproved, ShouldInitializeIntoReadyAndDefrostingWhenSystemIsNotWaitingToDefrostOnInit)
{
   GivenWaitingToDefrostIs(false);
   GivenReadyToDefrostIsInitialized();
...
TEST(ReadyToDefrostImproved, ShouldResetCompressorOnTimeAndDoorAccelerationsToZeroIfFreezerIsTooWarmAtPowerUpOnInit)
{
...
TEST(ReadyToDefrostImproved, ShouldNotResetCompressorOnTimeAndDoorAccelerationsToZeroIfFreezerIsNotTooWarmAtPowerUpOnInit)
{
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenDoorAccelerationsAre(SomeDoorAccelerationsInSecondsPerSecond);
   GivenFreezerTooWarmAtPowerUpIs(false);
...
TEST(ReadyToDefrostImproved, ShouldTransitionFromWaitingForMinimumTimeBetweenDefrostsToReadyAndDefrostingWhenNoLongerWaitingToDefrostAndResetCompressorOnTimeAndDoorAccelerationsToZero)
{
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenDoorAccelerationsAre(SomeDoorAccelerationsInSecondsPerSecond);
   GivenWaitingToDefrostIs(true);
...
TEST(ReadyToDefrostImproved, ShouldTransitionFromWaitingForRemainingTimeBetweenDefrostsToReadyAndDefrostingWhenNoLongerWaitingToDefrostAndResetCompressorOnTimeAndDoorAccelerationsToZero)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenDoorAccelerationsAre(SomeDoorAccelerationsInSecondsPerSecond);
   GivenWaitingToDefrostIs(true);
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostOnInitWhenCompressorOnTimeHasNotReachedMinimumButSumOfCompressorOnTimeAndDoorAccelerationsIsEqualToMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostOnInitWhenCompressorOnTimeHasNotReachedMinimumButSumOfCompressorOnTimeAndDoorAccelerationsIsGreaterThanMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostOnInitWhenCompressorOnTimeIsEqualToMinimumTimeButSumOfCompressorOnTimeAndDoorAccelerationsIsLessThanMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostOnInitWhenCompressorOnTimeIsGreaterThanMinimumTimeButSumOfCompressorOnTimeAndDoorAccelerationsIsLessThanMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 2);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostOnInitWhenCompressorOnTimeIsLessThanMinimumTimeAndSumOfCompressorOnTimeAndDoorAccelerationsIsLessThanMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostOnInitWhenCompressorOnTimeIsLessThanMinimumTimeAndTimeBetweenDefrostsIsMin)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostOnInitIfCompressorOnTimeIsEqualToMinimumTimeAndTimeBetweenDefrostsIsMinAndTransitionToReadyAndDefrostingWhenWaitingToDefrostChangesToFalse)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostOnInitIfCompressorOnTimeIsGreaterThanMinimumTimeAndTimeBetweenDefrostsIsMin)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostOnInitWhenCompressorOnTimeIsEqualToMinimumTimeAndTheSumOfCompressorOnTimeAndDoorAccelerationsIsEqualToMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostOnInitWhenCompressorOnTimeIsEqualToMinimumTimeAndTheSumOfCompressorOnTimeAndDoorAccelerationsIsGreaterThanMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostOnInitWhenCompressorOnTimeIsGreaterThanMinimumTimeAndTheSumOfCompressorOnTimeAndDoorAccelerationsIsEqualToMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostOnInitWhenCompressorOnTimeIsGreaterThanMinimumTimeAndTheSumOfCompressorOnTimeAndDoorAccelerationsIsGreaterThanMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostOnInitWhenCompressorOnTimeIsLessThanMinimumTimeAndTheSumOfCompressorOnTimeAndDoorAccelerationsIsGreaterThanMaximumTimeBetweenDefrostsAndTimeBetweenDefrostsIsMax)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 2);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, )
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
...
TEST(ReadyToDefrostImproved, )
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 2);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsFalse();
...
TEST(ReadyToDefrostImproved, ShouldTransitionFromReadyAndDefrostingToWaitingForMinimumTimeBetweenDefrostsWhenWaitingToDefrostChangesToTrueAndShouldNotSetReadyToDefrostIfTimeBetweenDefrostsIsMinAndCompressorOnTimeLessThanMinimumTimeBetweenDefrosts)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsFalse();
   ReadyToDefrostHsmStateShouldBe(ReadyToDefrostHsmState_ReadyAndDefrosting);
...
TEST(ReadyToDefrostImproved, )
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsFalse();
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMaxTimeBetweenDefrostsWhenNoneOfTheConditionsCausingItToBeMinimumAreTrueOnEntryOfWaitingForMinimumTimeBetweenDefrosts)
{
   GivenFreshFoodDefrostWasAbnormalIs(false);
   GivenFreezerDefrostWasAbnormalIs(false);
   GivenConvertibleCompartmentDefrostWasAbnormalIs(false);
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMaxTimeBetweenDefrostsWhenNoneOfTheConditionsCausingItToBeMinimumAreTrueOnEntryOfWaitingForRemainingTimeBetweenDefrosts)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMinTimeBetweenDefrostsWhenFreshFoodDefrostWasAbnormalOnEntryOfWaitingForMinimumTimeBetweenDefrosts)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMinTimeBetweenDefrostsWhenFreezerDefrostWasAbnormalOnEntryOfWaitingForMinimumTimeBetweenDefrosts)
{
   GivenFreshFoodDefrostWasAbnormalIs(false);
   GivenFreezerDefrostWasAbnormalIs(true);
   GivenConvertibleCompartmentDefrostWasAbnormalIs(false);
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMinTimeBetweenDefrostsWhenConvertibleCompartmentDefrostWasAbnormalAndItHasAConvertibleCompartmentOnEntryOfWaitingForMinimumTimeBetweenDefrosts)
{
   GivenFreshFoodDefrostWasAbnormalIs(false);
   GivenFreezerDefrostWasAbnormalIs(false);
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateTimeBetweenDefrostsToMinTimeBetweenDefrostsWhenConvertibleCompartmentDefrostWasAbnormalAndItDoesNotHaveAConvertibleCompartmentOnEntryOfWaitingForMinimumTimeBetweenDefrosts)
{
   GivenFreshFoodDefrostWasAbnormalIs(false);
   GivenFreezerDefrostWasAbnormalIs(false);
   GivenConvertibleCompartmentDefrostWasAbnormalIs(true);
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMinTimeBetweenDefrostsOnEntryOfWaitingForMinimumTimeBetweenDefrostsBecauseInvalidFreezerEvaporatorThermistorChangedToTrueWhileDefrosting)
{
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsFalse();
   ReadyToDefrostHsmStateShouldBe(ReadyToDefrostHsmState_ReadyAndDefrosting);
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMinTimeBetweenDefrostsWhenFreezerTooWarmAtPowerIsTrueOnEntryOfWaitingForMinimumTimeBetweenDefrosts)
{
   GivenFreshFoodDefrostWasAbnormalIs(false);
   GivenFreezerDefrostWasAbnormalIs(false);
   GivenConvertibleCompartmentDefrostWasAbnormalIs(false);
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMinTimeBetweenDefrostsWhenEepromClearedFlagIsTrueOnEntryOfWaitingForMinimumTimeBetweenDefrosts)
{
   GivenFreshFoodDefrostWasAbnormalIs(false);
   GivenFreezerDefrostWasAbnormalIs(false);
   GivenConvertibleCompartmentDefrostWasAbnormalIs(false);
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMinTimeWhenUseMinimumReadyToDefrostIsSetToTrueWhileInWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorOnTimeInSecondsIs(0);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateTimeBetweenDefrostsToMinTimeWhenUseMinimumReadyToDefrostIsSetToTrueWhileInWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
   ReadyToDefrostHsmStateShouldBe(ReadyToDefrostHsmState_WaitingForRemainingTimeBetweenDefrosts);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMinimumTimeWhenUseMinimumReadyToDefrostTimeAndResetDefrostCountsErdChangedToTrueDuringWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE + 1);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
   ReadyToDefrostHsmStateShouldBe(ReadyToDefrostHsmState_WaitingForRemainingTimeBetweenDefrosts);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMinimumTimeWhenUseMinimumReadyToDefrostTimeAndResetDefrostCountsErdChangedToTrueDuringWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenTimeBetweenDefrostsIsMaximumAndWaitingToDefrostIsTrue();
   ReadyToDefrostHsmStateShouldBe(ReadyToDefrostHsmState_WaitingForMinimumTimeBetweenDefrosts);
...
TEST(ReadyToDefrostImproved, ShouldResetCompressorOnTimeAndDoorAccelerationsWhenReceivingResetDefrostCountsSignalWhileInWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenDoorAccelerationsAre(SomeDoorAccelerationsInSecondsPerSecond);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldResetCompressorOnTimeAndDoorAccelerationsWhenReceivingResetDefrostCountsSignalWhileInWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
   GivenDoorAccelerationsAre(SomeDoorAccelerationsInSecondsPerSecond);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldResetCompressorOnTimeAndDoorAccelerationsWhenReceivingResetDefrostCountsSignalWhileInWaitingForReadyAndDefrostingState)
{
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenDoorAccelerationsAre(SomeDoorAccelerationsInSecondsPerSecond);
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingToDefrostTimeToTotalCompressorOnTimeOnEntryToWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateTotalCompressorOnTimeForTimeThatCompressorIsOnDuringWaitingForMinimumTimeBetweenDefrostsStateIfCompressorIsOnDuringEntryAndTurnsOffLater)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateTotalCompressorOnTimeForTimeThatCompressorIsOnDuringWaitingForMinimumTimeBetweenDefrostsStateIfCompressorTurnsOnAfterEntryThenTurnsOffLater)
{
   GivenCompressorIs(OFF);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldAccumulateCompressorOnTimeAsItTurnsOnAndOffDuringWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorIs(OFF);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdOnceCompressorOnTimeReachesMinimumTimeBetweenDefrostsWhenCompressorIsOnFromEntryOfWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(0);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdOnceCompressorOnTimeReachesMinimumTimeBetweenDefrostsWithCompressorTurningOnAndOffNotAtPeriodicUpdateTimeIntervalsDuringMinimumTimeBetweenDefrostsState)
{
   GivenCompressorIs(ON);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdOnceCompressorOnTimeReachesMinimumTimeBetweenDefrostsWithCompressorTurningOnAndOffDuringMinimumTimeBetweenDefrostsStateAndStartingCompressorOnTimeGreaterThanZero)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 5 * UpdatePeriodInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeToTotalCompressorTimeDuringWaitingForMinimumTimeBetweenDefrostsStatesWheneverCompressorTurnsOff)
{
   GivenCompressorIs(OFF);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldClearReadyToDefrostWhenStartingToWaitToDefrostTheNextTime)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldStartOverAtZeroCompressorOnTimeWhenWaitingToDefrostChangesFromFalseToTrueAndThereWasAccumulatedCompressorOnTimeBeforeTheChange)
{
   GivenCompressorIs(ON);
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 1);
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostAfterMinimumTimeBetweenDefrostsIfCompressorWasNotOnForMinimumTimeBetweenDefrostsAndThenShouldSetReadyToDefrostOnceCompressorIsOnForThatLong)
{
   GivenCompressorIs(OFF);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeAfterPeriodicUpdateTimeEvenIfCompressorDidNotTurnOff)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeAfterPeriodicUpdateTimeEvenIfCompressorIsOff)
{
   GivenCompressorIs(OFF);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeInSecondsAfterPeriodicUpdateTimeEvenIfCompressorDidNotTurnOff)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeEveryPeriodicUpdateTimeWhenCompressorDoesNotTurnOff)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdWhenThereIsPeriodicUpdateTimeLeftToReachMinimumCompressorOnTime)
{
   GivenCompressorIs(ON);
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeAfterPeriodicUpdateTimeAfterCompressorTurnedOn)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeEveryPeriodicUpdateTimeAfterCompressorTurnedOn)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostAfterCompressorTurnsOnAndRemainingMinimumTimeIsLessThanPeriodicUpdateTime)
{
   GivenCompressorIs(ON);
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeAfterPeriodicUpdateTimeAfterCompressorTurnsOff)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsWhenADoorClosesThatWasOpenOnInitWhileWaitingForMinimumTimeBetweenDefrosts)
{
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingToDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsWhenMoreThanOneDoorIsAlreadyOpenOnInitAndThenOneClosesAfterTheOtherWhileWaitingForMinimumTimeBetweenDefrostsAndOnlyIncrementDoorAccelerationsForTimeThatADoorIsOpen)
{
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenFreezerDoorIs(Open);
   GivenConvertibleCompartmentDoorAsFreshFoodDoorIs(Open);
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeWhenDoorClosesWhileWaitingForMinimumTimeBetweenDefrostsIfCompressorIsAlreadyOnAndADoorIsAlreadyOpenOnInit)
{
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeWhenDoorClosesWhileWaitingForMinimumTimeBetweenDefrostsIfCompressorIsOffAndADoorIsAlreadyOpenOnInit)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeWhenDoorClosesWhileWaitingForMinimumTimeBetweenDefrostsIfCompressorIsAlreadyOnAndADoorIsAlreadyOpenOnInit)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeWhenDoorOpensWhileWaitingForMinimumTimeBetweenDefrostsIfCompressorIsAlreadyOnAndDoorsAreClosedOnInit)
{
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeWhenADoorOpensWithAnotherOneClosedWhileWaitingForMinimumTimeBetweenDefrostsIfCompressorIsAlreadyOffAndAtLeastOneDoorIsOpenOnInit)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeWhenDoorOpensWhileWaitingForMinimumTimeBetweenDefrostsIfCompressorIsAlreadyOnAndADoorIsClosedOnInit)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationAndCompressorOnTimeAfterDoorIsOpenThenClosed)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostAfterCompressorIsOnForMinimumTimeWhileADoorOpenedThenClosedDuringMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostAfterCompressorIsOnForMinimumTimeWhileADoorClosedThenOpenedDuringMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationForOpenDoorWhenCompressorTurnsOffDuringMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateDoorAccelerationsWhenCompressorTurnsOffIfDoorIsClosedDuringMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationForOpenDoorThatClosesAfterCompressorTurnsOffDuringMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsForDoorThatOpensThenClosesWhileCompressorIsOffDuringMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOffAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsWhenCompressorTurnsOnAndAfterTheDoorClosesForAnOpenDoorDuringMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOffAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsForDoorThatIsStillOpenWhileAnotherDoorOpenThenClosesAndCompressorIsOffDuringMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsClosedAndFreezerDoorIsOpenAndCompressorIsOffAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostWhenTimerExpiresAfterInfiniteTimeFromWhenADoorClosedWhenCompressorWasNotOnForMinimumTime)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOffAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsWhenMinimumTimeReached)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeAndWaitingToDefrostTimeWhenMinimumTimeReachedAndCompressorIsOn)
{
   GivenLeftHandFreshFoodDoorIsOpenAndFreezerDoorIsClosedAndConvertibleCompartmentDoorAsFreshFoodDoorIsOpenAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeOrWaitingToDefrostTimeWhenTimerExpiresAfterInfiniteTimeAndCompressorIsNotOn)
{
   GivenLeftHandFreshFoodDoorIsOpenAndFreezerDoorIsClosedAndConvertibleCompartmentDoorAsFreshFoodDoorIsOpenAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeInSecondsOnEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeWhenCompressorTurnsOffAfterBeingOnUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenCompressorIs(ON);
   GivenTimeBetweenDefrostsIsMaximumAndCompressorOnTimeIsAtMinimumAndInWaitingForRemainingTimeBetweenDefrostsState();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsIsReachedWithCompressorOn)
{
   GivenCompressorIs(ON);
   GivenTimeBetweenDefrostsIsMaximumAndCompressorOnTimeIsAtMinimumAndInWaitingForRemainingTimeBetweenDefrostsState();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsIsReachedWithCompressorOnAndSomePreviousDoorAccelerations)
{
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(SomeSeconds);
   GivenFreezerDoorAccelerationInSecondsIs(SomeSeconds);
   GivenCompressorIs(ON);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsIsReachedWithCompressorOnAndADoorOpen)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsForOpenDoorsWhenCompressorTurnsOffAfterBeingOnUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeInSecondsWhenCompressorTurnsOffAfterBeingOnUponEntryAndADoorWasAlsoOpenUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenLeftHandFreshFoodDoorIsOpenAndFreezerDoorIsOpenAndCompressorIsOnAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsIsReachedWithCompressorOffAndADoorOpen)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsForOpenDoorsWhenCompressorTurnsOnAfterBeingOffUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeInSecondsWhenCompressorTurnsOnAfterBeingOffUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenLeftHandFreshFoodDoorIsOpenAndFreezerDoorIsOpenAndConvertibleCompartmentAsFreshFoodDoorIsClosedAndCompressorIsOffAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsForDoorThatClosedWhenDoorClosesAfterBeingOpenUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenTimeBetweenDefrostsIsMaximumAndCompressorOnTimeIsAtMinimumAndInWaitingForRemainingTimeBetweenDefrostsState();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsForDoorsThatRemainOpenWhenADoorClosesAfterBeingOpenUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeWhenDoorClosesAndCompressorWasOnUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeWhenDoorClosesAndCompressorWasOffUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOffAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeInSecondsWhenDoorClosesAfterBeingOpenUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsForDoorThatWasOpenWhenADifferentDoorOpensAfterBeingClosedUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeWhenDoorOpensAndCompressorWasOnUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeWhenDoorOpensAndCompressorWasOffUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeInSecondsWhenDoorOpensAfterBeingOpenUponEntryToWaitingForRemainingTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterTheCompressorTurnsOffButADoorRemainsOpen)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterTheCompressorTurnsOffAndDoorsAreClosed)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOnAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterTheCompressorTurnsOnAndDoorsAreClosed)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOffAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterTheCompressorTurnsOnAndADoorIsOpen)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOffAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterADoorOpensAndTheCompressorIsOn)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOnAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterADoorOpensAndTheCompressorIsOff)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOffAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterADoorClosesAndTheCompressorIsOn)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterADoorClosesAndTheCompressorIsOff)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOffAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterADoorClosesAndTheCompressorIsOnAndAnotherDoorIsStillOpen)
{
   GivenLeftHandFreshFoodDoorIsOpenAndFreezerDoorIsOpenAndCompressorIsOnAndTimeBetweenDefrostsIsMaximumAndInWaitingForRemainingTimeBetweenDefrostsState();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMaximumTimeBetweenDefrostsAfterADoorClosesAndTheCompressorIsOffAndAnotherDoorIsStillOpen)
{
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostErdWhenUseMinimumReadyToDefrostIsSetToTrueWhileInWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenTimeBetweenDefrostsIsMaximumAndCompressorOnTimeIsAtMinimumAndInWaitingForRemainingTimeBetweenDefrostsState();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsWhenMaximumTimeReachedForOpenDoors)
{
   GivenLeftHandFreshFoodDoorIsOpenAndFreezerDoorIsOpenAndCompressorIsOffAndTimeBetweenDefrostsIsMaximumAndInWaitingForRemainingTimeBetweenDefrostsState();
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeWhenMaximumTimeReachedIfCompressorIsOn)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateCompressorOnTimeWhenMaximumTimeReachedIfCompressorIsTurnedOnLater)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOffAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateWaitingDefrostTimeInSecondsWhenMaximumTimeReached)
{
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOffAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldResetWaitingDefrostTimeInSecondsToZeroWhenNoLongerWaitingToDefrost)
{
   GivenCompressorIs(ON);
   GivenTimeBetweenDefrostsIsMaximumAndCompressorOnTimeIsAtMinimumAndInWaitingForRemainingTimeBetweenDefrostsState();
...
TEST(ReadyToDefrostImproved, ShouldTransitionFromWaitingForMinimumTimeBetweenDefrostsToWaitingForRemainingTimeBetweenDefrostsWhenTimerExpiresAndItIsNotReadyToDefrost)
{
   GivenCompressorIs(ON);
...
TEST(ReadyToDefrostImproved, ShouldNotSetReadyToDefrostErdAfterMinimumTimeWhenResetDefrostCountsSignalWasReceivedWhileInWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorIs(ON);
   GivenCompressorOnTimeInSecondsIs(0);
   GivenTimeBetweenDefrostsIsMinimumAndWaitingForDefrostIsTrue();
...
TEST(ReadyToDefrostImproved, ShouldRestartMinimumTimeWhenResetDefrostCountsSignalWasReceivedAndSetReadyToDefrostErdAfterCompressorHasBeenOnForMinimumTimeWhileInWaitingForMinimumTimeBetweenDefrostsState)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsPeriodicallyEvenIfDoorsDoNotCloseWhileWaitingForMinimumTimeBetweenDefrosts)
{
   GivenLeftHandFreshFoodDoorIsOpenAndFreezerDoorIsClosedAndConvertibleCompartmentDoorAsFreshFoodDoorIsOpenAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsPeriodicallyAfterADoorOpensAndCompressorIsOffWhileWaitingForMinimumTimeBetweenDefrostsAndStopUpdatingAfterTheDoorCloses)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOffAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldStopUpdatingDoorAccelerationsPeriodicallyAfterTheDoorClosesWhileWaitingForMinimumTimeBetweenDefrosts)
{
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeOrSetReadyToDefrostErdAfterCompressorTurnsOffAndWasNotOnLongEnoughToReachMinimumTimeWhileWaitingForMinimumTimeBetweenDefrosts)
{
   GivenLeftHandFreshFoodDoorIsClosedAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterALessThanPeriodicUpdateTimeAfterADoorOpensWhenCompressorHasAccumulatedMinimumTimeBetweenDefrostsWhileWaitingForMinimumTimeBetweenDefrosts)
{
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsWhenSomeDoorOpenTimeAfterResetDefrostCountsRequestReceivedWhileInWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorIs(OFF);
   GivenCompressorOnTimeInSecondsIs(0);
   GivenLeftHandFreshFoodDoorIs(Open);
...
TEST(ReadyToDefrostImproved, ShouldResetWaitingForDefrostTimeInSecondsWhenResetDefrostCountRequestReceivedWhileInWaitingForMinimumTimeBetweenDefrostsState)
{
   GivenCompressorIs(OFF);
   GivenCompressorOnTimeInSecondsIs(SomeCompressorOnTimeInSeconds);
   GivenWaitingToDefrostIsTrueAndReadyToDefrostIsInitialized();
...
TEST(ReadyToDefrostImproved, ShouldResetWaitingForDefrostTimeInSecondsWhenResetDefrostCountRequestReceivedWhileInWaitingForRemainingTimeBetweenDefrostsState)
{
   GivenLeftHandFreshFoodDoorIsOpenAndFreezerDoorIsOpenAndCompressorIsOnAndWaitingForRemainingTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterMinimumTimeWhenUseMinimumReadyToDefrostTimeAndResetDefrostCountsErdChangesToTrueDuringReadyAndDefrostingAfterWaitingToDefrostIsTrue)
{
...
TEST(ReadyToDefrostImproved, ShouldUseMaximumTimeOnNextDefrostAfterBeingForcedToUseMinimumTimeByUseMinimumTimeErd)
{
   GivenTimeBetweenDefrostsIsMaximumAndCompressorOnTimeIsEqualToMinimumAndWaitingToDefrostIsFalseAndStateIsReadyAndDefrosting();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterALessThanPeriodicUpdateTimeAfterADoorClosesWhenCompressorHasAccumulatedMinimumTimeBetweenDefrostsWhileWaitingForMinimumTimeBetweenDefrosts)
{
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE - 2 * (UpdatePeriodInSeconds));
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOnAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsCorrectlyAfterUseMinimumReadyToDefrostTimeAndResetDefrostCountsErdChangesToTrueDuringAPeriodicUpdatePeriod)
{
   GivenLeftHandFreshFoodDoorAccelerationInSecondsIs(SomeDoorAccelerationsInSecondsPerSecond);
   GivenLeftHandFreshFoodDoorIsOpenAndCompressorIsOffAndItIsWaitingForMinimumTimeBetweenDefrosts();
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterHalfAPeriodicUpdatePeriodWithTheCompressorOnIfCompressorOnTimeIsMaxMinusHalfAPeriodicUpdatePeriodWhenInitializedIntoWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(ON);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterHalfAPeriodicUpdatePeriodWithADoorOpenAndCompressorOffIfCompressorOnTimeIsMaxMinusHalfAPeriodicUpdatePeriodWhenInitializedIntoWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(OFF);
   GivenLeftHandFreshFoodDoorIs(Open);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterHalfAPeriodicUpdatePeriodFromWhenTheCompressorTurnedOnIfCompressorOnTimeIsMaxMinusHalfAPeriodicUpdatePeriodWhenInitializedIntoWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(OFF);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - (UpdatePeriodInSeconds) / 2);
   GivenWaitingToDefrostIs(true);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterHalfAPeriodicUpdatePeriodFromWhenCompressorTurnsOffIfThereIsADoorOpenAndIfCompressorOnTimeIsMaxMinusHalfAPeriodicUpdatePeriodWhenInitializedIntoWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(ON);
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - (defrostData->idleData.freshFoodDoorIncrementFactorInSecondsPerSecond * (UpdatePeriodInSeconds)) / 2);
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateCompressorOnTimeAfterCompressorHasBeenTurnedOffWhileWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(ON);
   GivenLeftHandFreshFoodDoorIs(Closed);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterATimeLessThanPeriodicUpdatePeriodFromWhenADoorOpensIfCompressorIsOnAndIfRemainingTimeUntilReadyIsLessThanPeriodicUpdatePeriodWhenInitializedIntoWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(ON);
   GivenLeftHandFreshFoodDoorIs(Closed);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - (defrostData->idleData.freshFoodDoorIncrementFactorInSecondsPerSecond * (UpdatePeriodInSeconds)) / 2);
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterATimeLessThanPeriodicUpdatePeriodFromWhenADoorOpensIfCompressorIsOffAndIfRemainingTimeUntilReadyIsLessThanPeriodicUpdatePeriodWhenInitializedIntoWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(OFF);
   GivenLeftHandFreshFoodDoorIs(Closed);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - (defrostData->idleData.freshFoodDoorIncrementFactorInSecondsPerSecond * (UpdatePeriodInSeconds / 2)));
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterATimeLessThanPeriodicUpdatePeriodFromWhenADoorClosesIfCompressorIsOnAndIfRemainingTimeUntilReadyIsLessThanPeriodicUpdatePeriodWhenInitializedIntoWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(ON);
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.maxTimeBetweenDefrostsInMinutes * SECONDS_PER_MINUTE - (UpdatePeriodInSeconds / 2));
...
TEST(ReadyToDefrostImproved, ShouldSetReadyToDefrostErdAfterATimeLessThanPeriodicUpdatePeriodFromWhenADoorClosesIfCompressorIsOffAndADoorIsStillOpenAndIfRemainingTimeUntilReadyIsLessThanPeriodicUpdatePeriodWhenInitializedIntoWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(OFF);
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenFreezerDoorIs(Open);
...
TEST(ReadyToDefrostImproved, ShouldUpdateDoorAccelerationsPeriodicallyWhileWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(OFF);
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenFreezerDoorIs(Open);
...
TEST(ReadyToDefrostImproved, ShouldNotUpdateDoorAccelerationsAfterAllDoorsHaveBeenClosedWhileWaitingForRemainingTimeBetweenDefrosts)
{
   GivenCompressorIs(OFF);
   GivenLeftHandFreshFoodDoorIs(Open);
   GivenCompressorOnTimeInSecondsIs(defrostData->idleData.minimumTimeBetweenDefrostsAbnormalRunTimeInMinutes * SECONDS_PER_MINUTE);
