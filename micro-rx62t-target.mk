...
export TARGET:=micro-rx62t
OUTPUT_DIR:=build/$(TARGET)
BOOT_LOADER_DIR:=lib/boot-loaders
BOOT_LOADER_TARGET:=small-rx62t
...
.PHONY: package
package: all artifacts erd_lock
...
erd_definitions: $(OUTPUT_DIR)/doc toolchain
	...
	@$(CC) $(addprefix -I,$(INC_DIRS) $(SRC_DIRS)) -E -P -MMD src/MicroApplication/DataSource/MicroSystemErds.h -o $(OUTPUT_DIR)/temporary.h
