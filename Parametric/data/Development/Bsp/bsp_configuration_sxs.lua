local erd_list = {
  ...
  { input = bsp_mapped_erd.Erd_AmbientThermistor_AdcCount,                output = bsp_erd.Erd_Adc_ANALOG_TH_LOW_03 },
  ...
  { input = bsp_mapped_erd.Erd_IceMaker1_FillTubeHeater,                  output = bsp_erd.Erd_SoftPwmGpio_HTR_02 },
