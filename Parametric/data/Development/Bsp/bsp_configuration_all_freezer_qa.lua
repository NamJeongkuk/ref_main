local erd_list = {
   ...
   { input = bsp_mapped_erd.Erd_FreezerTopLight_RampingPwm,                output = bsp_erd.Erd_RampingLedPwm_PWM_200_00 },
   { input = bsp_mapped_erd.Erd_FreezerBackWallLight_RampingPwm,           output = bsp_erd.Erd_RampingLedPwm_PWM_200_01 },
   ...
   { input = bsp_mapped_erd.Erd_IceMaker0_MoldThermistor_AdcCount,         output = bsp_erd.Erd_Adc_ANALOG_TH_LOW_06 },
 
   { input = bsp_mapped_erd.Erd_IceMaker0_FillTubeHeater,                  output = bsp_erd.Erd_SoftPwmGpio_HTR_04 },
 
   { input = bsp_mapped_erd.Erd_IceMaker0_HeaterRelay,                     output = bsp_erd.Erd_Gpio_RLY_02 },
   { input = bsp_mapped_erd.Erd_IceMaker0_WaterValveRelay,                 output = bsp_erd.Erd_Gpio_RLY_03 },
   { input = bsp_mapped_erd.Erd_IceMaker0_RakeMotorRelay,                  output = bsp_erd.Erd_Gpio_RLY_06 },
