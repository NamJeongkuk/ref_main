return personality({
  ...
  fresh_food_and_freezer_grid = import("../Grid/single_evap_grid_integration.lua"),
  fresh_food_and_freezer_grid_deltas = import("../Grid/grid_deltas_integration.lua"),
  ...
  sabbath = import("../Sabbath/sabbath_time_between_defrosts_during_fresh_food_stage.lua"),
