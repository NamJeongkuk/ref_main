return personality({
  ...
  platform = import("../Platform/three_door_dual_evap_platform.lua"),
  ...
  fresh_food_non_heated_cycle_defrost = import("../NonHeatedCycleDefrost/fresh_food_non_heated_cycle_defrost_fan_enable_off.lua")
})
