return aluminum_mold_ice_maker({
  fill = {
    ice_maker_fill_monitor = import("../IceMaker/aluminum_mold_ice_maker_fill_monitor_qa.lua")
  },
  freeze = {
    harvest_count_calculator = import("../IceMaker/aluminum_mold_harvest_count_calculator_qa.lua"),
  ...
  harvest_fix = {
    ...
    maximum_harvest_fix_time_in_minutes = 6
  }
})
