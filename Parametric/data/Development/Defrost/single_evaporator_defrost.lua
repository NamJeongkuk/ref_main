return defrost({
  idle = {
    ...
    minimum_time_between_defrosts_abnormal_run_time_in_minutes = 2 * 60,
    max_time_between_defrosts_in_minutes = 3 * 60,
    aham_prechill_time_between_defrosts_in_minutes = 1 * 60
  },
  prechill_prep = {
    number_of_fresh_food_defrosts_before_freezer_defrost = 0,
    number_of_fresh_food_defrosts_before_abnormal_freezer_defrost = 0,
