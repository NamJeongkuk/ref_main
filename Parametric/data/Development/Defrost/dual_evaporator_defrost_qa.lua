return defrost({
  ...
  heater_on = {
    freezer_defrost_heater_max_on_time_in_minutes = 5,
    ...
    fresh_food_defrost_heater_max_on_time_in_minutes = 5,
    fresh_food_invalid_thermistor_defrost_heater_max_on_time_in_minutes = 1,
    fresh_food_heater_on_time_to_set_abnormal_defrost_in_minutes = 3,
    convertible_compartment_defrost_heater_max_on_time_in_minutes = 5,
