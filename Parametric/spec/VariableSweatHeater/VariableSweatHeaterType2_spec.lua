...
describe('VariableSweatHeaterType2', function()
  local variable_sweat_heater = VariableSweatHeaterType2(core_mock)
  ...
  it('should generate a typed string with the correct data and type for variable_sweat_heater', function()
    ...
    assert(actual.is_of_type('variable_sweat_heater_type_2'))
  end)
