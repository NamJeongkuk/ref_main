...
describe('VariableSweatHeaterType7', function()
  local variable_sweat_heater = VariableSweatHeaterType7(core_mock)
  ...
  it('should generate a typed string with the correct data and type for variable_sweat_heater', function()
    ...
    assert(actual.is_of_type('variable_sweat_heater_type_7'))
  end)
