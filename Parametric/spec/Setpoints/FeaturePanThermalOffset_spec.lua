local FeaturePanThermalOffset = require 'Setpoints/FeaturePanThermalOffset'
...
describe('FeaturePanThermalOffset', function()
  local feature_pan_thermal_offset = FeaturePanThermalOffset(core_mock)
  ...
  it('should require fixed setpoint and shift offset arguments', function()
    should_require_args(feature_pan_thermal_offset, generate_config_as_deli_pan())
  end)
  ...
  it('should constrain all arguments', function()
    should_fail_with('cross_ambient_offset_as_fresh_food must be a typed string with type cross_ambient_offset, but is a number', function()
      feature_pan_thermal_offset(generate_config_as_convertible_compartment({
  ...
  it('should generate a typed string with the correct data and type for convertible compartment adjusted setpoint', function()
    ...
    local actual = feature_pan_thermal_offset(generate_config_as_convertible_compartment())

    assert.equals(expected, remove_whitespace(tostring(actual)))
    assert(actual.is_of_type('feature_pan_thermal_offset'))
  end)
  ...
  it('should generate a typed string with the correct data and type for deli pan adjusted setpoint', function()
    ...
    local actual = feature_pan_thermal_offset(generate_config_as_deli_pan())
  ...
  it('should memoize', function()
    should_memoize_calls(feature_pan_thermal_offset, generate_config_as_convertible_compartment())
    should_memoize_calls(feature_pan_thermal_offset, generate_config_as_deli_pan())
  end)
end)
