...
describe('userSetpoint', function()
  local userSetpoint = UserSetpoint(core_mock)
  ...
  it('should require all arguments', function()
    should_require_args(userSetpoint, generate_config())
  end)
  ...
  it('should generate a typed string with the correct data and type for user_setpoint', function()
    ...
    local actual = userSetpoint(generate_config())
  ...
  it('should memoize', function()
    should_memoize_calls(userSetpoint, generate_config())
  end)
end)
