...
describe('RefrigeratorModel', function()
  ...
  it('should require refrigerator_model_type to be a valid refrigerator model type', function()
    should_fail_with("refrigerator_model_type='among_us_refrigerator' must be in the set { 'bottom_freezer_french_door', 'bottom_freezer_one_door', 'side_by_side', 'single_cabinet_fresh_food', 'single_cabinet_freezer', 'top_freezer', 'convertible_drawer_double_drawer_bottom_freezer', 'convertible_drawer_quad_door', 'f_and_p_wine_column', 'f_and_p_columns_b', 'dual_zone_wine_chiller', 'beverage_center', 'f_and_p_columns_fresh_food', 'f_and_p_columns_freezer', 'f_and_p_60cm_single_door', 'f_and_p_60cm_multi-door', 'f_and_p_rf605_platform', 'f_and_p_active_smart_freestanding', 'f_and_p_active_smart_built_in', 'haier_counter_depth_platform', 'convertible_drawer_single_fresh_food_door_with_double_drawer_bottom_freezer' }", function()
