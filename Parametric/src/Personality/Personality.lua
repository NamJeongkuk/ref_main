...
return function(core)
  ...
  local generate = memoize(function(config)
    return TypedString(
      ...
      structure(
        ...
        pointer(config.duct_door_heater),
        pointer(config.ice_cabinet_gasket_heater),
        pointer(config.ice_duct_port_heater),
  ...
  return function(config)
    validate_arguments(config, {
      ...
      duct_door_heater = { constraint.typed_string('duct_door_heater') },
      ice_cabinet_gasket_heater = { constraint.typed_string('ice_cabinet_gasket_heater') },
      ice_duct_port_heater = { constraint.typed_string('ice_duct_port_heater') },
