  ...
  local generate = memoize(function(config)
    return TypedString(
      ...
      structure(
        ...
        config.high_ambient_humidity_and_high_temperature,
        config.high_ambient_humidity_and_low_temperature,
        config.high_ambient_humidity_and_high_temperature_ff_cooling_mode,
        config.high_ambient_humidity_and_low_temperature_ff_cooling_mode,
    ...
    elseif config.care_about_cooling_mode == true then
      validate_arguments(
        config,
        {
          ...
          high_ambient_humidity_and_high_temperature = { constraint.typed_string('speed') },
          high_ambient_humidity_and_low_temperature = { constraint.typed_string('speed') },
          high_ambient_humidity_and_high_temperature_ff_cooling_mode = { constraint.typed_string('speed') },
          high_ambient_humidity_and_low_temperature_ff_cooling_mode = { constraint.typed_string('speed') },
