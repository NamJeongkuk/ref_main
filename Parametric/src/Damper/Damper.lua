   ...
   local generate = memoize(function(config)
       return TypedString(
         ...
         structure(
           ...
           u16(config.max_time_for_damper_to_be_open_before_cycling_in_minutes),
           u16(config.max_time_for_damper_to_be_closed_before_cycling_in_minutes),
      ...
      if config.damper_id == damper_id.normal_damper then
        validate_arguments(
          config,
          {
            ...
            max_time_for_damper_to_be_open_before_cycling_in_minutes = { constraint.u16 },
            max_time_for_damper_to_be_closed_before_cycling_in_minutes = { constraint.u16 },
