...
return enum({
  'bottom_freezer_french_door',
  'bottom_freezer_one_door',
  'side_by_side',
  ...
  'beverage_center',
  'f_and_p_columns_fresh_food',
  'f_and_p_columns_freezer',
  'f_and_p_60cm_single_door',
  'f_and_p_60cm_multi-door',
  'f_and_p_rf605_platform',
