...
return function(core)
  ...
  local generate = memoize(function(config)
    ...
    return TypedString(
      { 'convertible_compartment_sensor_type' },
      structure(
        generate_table(sensorTable),
        i16(config.fresh_food_fallback_value_in_degfx100),
        i16(config.freezer_fallback_value_in_degfx100),
  ...
  return function(config)
    validate_arguments(config, {
      ...
      fresh_food_fallback_value_in_degfx100 = { constraint.i16 },
      freezer_fallback_value_in_degfx100 = { constraint.i16 },
